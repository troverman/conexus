...
module.exports = {
    ...
    //OAUTH2 APP
    //OPENID APP
    //TODO: REMOVE FILESYSTEM IN FAVOR OF ID SERILIZATION .. 
    ...
    serializeUser: function (user, next) {next(null, user.id);},
    deserializeUser: function (id, next) {User.findOne(id, next);},
