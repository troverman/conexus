(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["CidTool"] = factory();
	else
		root["CidTool"] = factory();
})(window, function() {
...
var mh = __webpack_require__(1);

var multibase = __webpack_require__(4);

var multicodec = __webpack_require__(30);

var codecs = __webpack_require__(5);

var CIDUtil = __webpack_require__(35);

var withIs = __webpack_require__(36);
/**
...
module.exports = function bases() {
  return multibase.names.map(function (name, i) {
    var code = multibase.codes[i];
    return {
      name: name,
      code: code
    };
...
module.exports = function codecs() {
  return Object.keys(CID.codecs).map(function (name) {
    var code = parseInt(CID.codecs[name].toString('hex'), 16);
    return {
      name: name,
      code: code
    };
...
exports.base32 = __webpack_require__(14);
exports.bases = __webpack_require__(9);
exports.codecs = __webpack_require__(10);
exports.format = __webpack_require__(37);
exports.hashes = __webpack_require__(38);
...
var explain = __webpack_require__(8);
...
var basex = __webpack_require__(6);
...
var base16 = __webpack_require__(27);

var base32 = __webpack_require__(28);

var base64 = __webpack_require__(29); // name, code, implementation, alphabet
...
var codecNameToCodeVarint = __webpack_require__(31);

var codeToCodecName = __webpack_require__(32);
...
exports.print = __webpack_require__(34);
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(0).Buffer))
...
var varintBufferEncode = __webpack_require__(7).varintBufferEncode; // this creates a map for codecName -> codeVarintBuffer
...
var bases = __webpack_require__(9);

var codecs = __webpack_require__(10);

var explain = __webpack_require__(8);

var multibase = __webpack_require__(4);

var multihash = __webpack_require__(1);

module.exports = function format(cid, options) {
  options = options || {};
  var formatStr = options.format || '%s';
  ...
  base = base || 'base58btc'; // Using multibase code instead of name

  if (base.length === 1) {
    var baseNameCode = bases().find(function (b) {
      return b.code === base;
    });
    if (!baseNameCode) throw new Error("invalid multibase: ".concat(base));
...
function replacer(cid, base, options) {
  return function (match, specifier) {
    switch (specifier) {
      ...
      case 'C':
        // codec code
        return codecs().find(function (c) {
          return c.name === cid.codec;
        }).code;
      ...
      case 'S':
        ...
        return cid.version === 1 ? cid.toBaseEncodedString(base).slice(1) : multibase.encode(base, cid.buffer).toString().slice(1);
...
var multihash = __webpack_require__(1); // TODO: list only safe hashes https://github.com/ipfs/go-verifcid


module.exports = function hashes() {
  return Object.keys(multihash.names).map(function (name) {
    return {
      name: name,
