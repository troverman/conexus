...
var multihashes = __webpack_require__(12);

var multihash = __webpack_require__(2);

var CID = __webpack_require__(5);

var strftime = __webpack_require__(53);

exports = module.exports;
exports.SHA1_LENGTH = multihashes.defaultLengths[multihashes.names.sha1];

exports.find = function (buf, _byte) {
...
exports.shaToCid = function (buf) {
  var mh = multihash.encode(buf, 'sha1');
  return new CID(1, 'git-raw', mh);
};

exports.cidToSha = function (cid) {
  var mh = multihash.decode(cid.multihash);
...
module.exports = {
  ...
  encodingLength: __webpack_require__(28)
};
...
var utils_1 = __webpack_require__(55); // The default Buffer size if one is not provided.
...
var multihashing = __webpack_require__(22);

var CID = __webpack_require__(5);

var multicodec = __webpack_require__(14);

var gitUtil = __webpack_require__(3);

var commit = __webpack_require__(54);
...
exports.serialize = function (dagNode) {
  if (dagNode === null) {
...
var codecNameToCodeVarint = __webpack_require__(47);

var codeToCodecName = __webpack_require__(48);
...
exports.print = __webpack_require__(50);
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(0).Buffer))
...
exports.resolver = __webpack_require__(58);
...
var errcode = __webpack_require__(23);
...
var mur = __webpack_require__(33);
...
module.exports = {
  ...
  addBlake: __webpack_require__(37)
};
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(31), __webpack_require__(9), __webpack_require__(10)(module)))
...
var blake = __webpack_require__(38);
...
var b2b = __webpack_require__(39);

var b2s = __webpack_require__(40);
...
var util = __webpack_require__(13); // 64-bit unsigned addition
...
// Adapted from the reference implementation in RFC7693
// Ported to Javascript by DC - https://github.com/dcposch
var util = __webpack_require__(13); // Little-endian byte access.
...
var base16 = __webpack_require__(44);

var base32 = __webpack_require__(45);

var base64 = __webpack_require__(46); // name, code, implementation, alphabet
...
var baseTable = __webpack_require__(6);

var varintBufferEncode = __webpack_require__(15).varintBufferEncode; // this creates a map for codecName -> codeVarintBuffer
...
var baseTable = __webpack_require__(6); // this creates a map for code as hexString -> codecName
...
var SmartBuffer = __webpack_require__(7).SmartBuffer;
      ...
      case 'mergetag':
        {
          ...
          for (; line < lines.length - 1; line++) {
            if (lines[line + 1][0] !== ' ') {
              tag.text = lines.slice(_startLine + 1, line + 1).join('\n');
              break;
            }
          }
