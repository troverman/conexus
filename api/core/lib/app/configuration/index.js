...
module.exports = function(sails) {
  ...
  function Configuration() {
    ...
    this.defaults = function defaultConfig(appPath) {
      ...
      if (!appPath) {throw new Error('No `appPath` specified!');}
      ...
      return {
        ...
        hooks: _.reduce(DEFAULT_HOOKS, function (memo, hookBundled, hookIdentity) {
          ...
          if (hookBundled === true) {memo[hookIdentity] = require('../../hooks/'+hookIdentity);}
          ...
          // otherwise freak out
          else {throw new Error('Sails internal error: `'+hookIdentity+'`, a core hook, is invalid!');}
          return memo;
        }, {}) || {},
        ...
        paths: {tmp: path.resolve(appPath, '.tmp')},
