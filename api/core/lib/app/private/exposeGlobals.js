...
module.exports = function exposeGlobals() {
  ...
  if (_.isUndefined(sails.config.globals)) {sails.config.globals = false; return;}
  ...
  if (sails.config.globals === false) {sails.log.verbose('No global variables will be exposed.'); return;}
