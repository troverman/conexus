...
angular.module("home/templates/intro.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("home/templates/intro.tpl.html",
    ...
    "                    <div style=\"padding:16px;\">                            \n" +
    "                        <div style=\"float:right\">\n" +
    "                            <h5 style=\"text-align:right\" ng-click=\"tokensToggle(item);$event.stopPropagation()\"><a>Tokens <i class=\"fa fa-question-circle\"></i></a></h5>\n" +
    "                        </div>\n" +
    ...
    "                            <p style=\"display:inline;color:gray;font-size:10px;margin-left:5px\" am-time-ago=\"item.createdAt\"></p>\n" +
    "\n" +
    "                            <p ng-click=\"$event.stopPropagation();tokensToggle(item)\" style=\"display:inline;float:right\"><a>Tokens <i class=\"fa fa-question-circle\"></i></a></p>\n" +
    "                            <div style=\"clear:both\"></div>\n" +
    "\n" +
    "                        </div>\n" +
    "\n" +
...
angular.module("market/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("market/index.tpl.html",
    ...
    "	<div class=\"row\">\n" +
    "	    <div class=\"card\">\n" +
    "	        <button class=\"btn btn-default log-btn\" ng-click=\"contentToggle()\">+ Market Content</button>\n" +
    "	    </div>\n" +
    "	</div>\n" +
    "\n" +
...
angular.module("member/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("member/index.tpl.html",
    ...
    "		<div ui-view=\"memberConsumption\"></div>\n" +
...
angular.module("member/templates/consumption.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("member/templates/consumption.tpl.html",
    "<div class=\"row\">\n" +
    "\n" +
    "    <div class=\"card\">\n" +
    "        <button class=\"btn btn-default log-btn\" ng-click=\"timeToggle()\">+ consumption</button>\n" +
    "    </div>\n" +
    "\n" +
    "    <div class=\"card\">\n" +
    "        <div style=\"padding:16px\">\n" +
...
angular.module("nav/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("nav/index.tpl.html",
    ...
    "                    <h4 class=\"nav-links\"><a href=\"member/{{member.username}}/consumption\">Consumption</a></h4>\n" +
...
angular.module("project/templates/tasks.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("project/templates/tasks.tpl.html",
    ...
    "    </div>\n" +
    "\n" +
    "	<div ng-show=\"tasks.length > 0\" class=\"col-sm-2\" style=\"padding-left:0px;padding-right:0px;\">\n" +
    "        <div class=\"card\">\n" +
    "            <div style=\"padding:16px;\">\n" +
    "				<span><b>Tags</b></span>\n" +
    "                <div ng-repeat=\"tag in sortedTagArray\">\n" +
...
angular.module("project/templates/time.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("project/templates/time.tpl.html",
    ...
    "    </div>\n" +
    "\n" +
    "    <div ng-show=\"time.length > 0\" class=\"col-sm-2\" style=\"padding-left:0px;padding-right:0px;\">\n" +
    "        <div class=\"card\">\n" +
    "            <div style=\"padding:16px;\">\n" +
    "                <span><b>Tags</b></span>\n" +
    "                <div ng-repeat=\"tag in sortedTagArray\">\n" +
