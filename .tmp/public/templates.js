...
angular.module("about/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("about/index.tpl.html",
    ...
    "							<a href=\"task/{{task.id}}\" ng-click=\"\"><i class=\"fa fa-angle-up\"></i> {{task.plusCount}} like </a> \n" +
    "							<a href=\"task/{{task.id}}\" ng-click=\"\" ><i class=\"fa fa-angle-down\"></i> {{task.minusCount}} dislike </a>\n" +
    "						</div>\n" +
    "					</div>\n" +
    "				</div>\n" +
    "\n" +
...
angular.module("content/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("content/index.tpl.html",
    ...
    "						<h5 style=\"text-align:right\" ng-click=\"toggleToken()\"><a href=\"#\">Tokens <i class=\"fa fa-question-circle\"></i></a></h5>\n" +
    ...
    "	</div>\n" +
    "\n" +
    "	<div class=\"row\" ng-show=\"!toggleTokenVar\">\n" +
    "		<div class=\"card\">\n" +
    "		    <div style=\"padding:16px\">\n" +
    "		    	<div class=\"row\">\n" +
    "\n" +
...
angular.module("home/templates/feed.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("home/templates/feed.tpl.html",
    ...
    "            <div class=\"card\" ng-show=\"item.model=='CONTENT'\" ng-click=\"\">\n" +
    ...
    "                        <p style=\"display:inline;float:right\"><a ng-click=\"sideNavToggle()\" href=\"#\">Tokens <i class=\"fa fa-question-circle\"></i></a></p>\n" +
    "                        <div style=\"clear:both\"></div>\n" +
    "\n" +
    "                    </div>\n" +
    ...
    "            </div>\n" +
    "            <!--TODO: FINALIZE-->\n" +
    "            <div class=\"card\" ng-show=\"item.model=='PROJECT'\" ng-click=\"\">\n" +
    "                <div style=\"padding:16px;\">\n" +
    "                    <div class=\"row\">\n" +
    "                        <div class=\"col-sm-1 col-xs-2\">\n" +
    ...
    "            </div>\n" +
    "            <!--TODO: FINALIZE-->\n" +
    "            <div class=\"card\" ng-show=\"item.model=='TASK'\" ng-click=\"\">\n" +
    "                <div style=\"padding:16px;\">\n" +
    "                    <div class=\"row\">\n" +
    "                        <div class=\"col-sm-10\">\n" +
    ...
    "                            <p><a ng-click=\"sideNavToggle()\" href=\"#\">Tokens <i class=\"fa fa-question-circle\"></i></a></p>\n" +
    "                        </div>\n" +
    "                    </div>\n" +
    "                </div>\n" +
    "                <div class=\"card-footer\">\n" +
    ...
    "                </div>\n" +
    "            </div>\n" +
    "            <div class=\"card\" ng-show=\"item.model=='WORK'\" ng-click=\"\">\n" +
    "                <div style=\"padding:16px;\">\n" +
    "                    <div>\n" +
    "                        <img class=\"card-avatar\" ng-src=\"{{item.user.avatarUrl}}\" src=\"{{item.user.avatarUrl}}\" err-src=\"/images/avatar.png\">\n" +
    "                        <a style=\"display:inline;font-weight:600;margin-left:5px\" href=\"/member/{{item.user.username}}\">{{item.user.username}}</a>\n" +
...
angular.module("home/templates/intro.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("home/templates/intro.tpl.html",
    ...
    "                    <li><a href=\"/tasks\">Tasks</a></li>\n" +
    "\n" +
    "                    <li ng-click=\"expandSort()\" style=\"float:right\"><a href=\"#\">Sort By Recent <i class=\"fa fa-angle-down\"></i></a></li>\n" +
    ...
    "</div>\n" +
    "\n" +
    "<div ng-show=\"false\" class=\"spacing-10\"></div>\n" +
    "<div ng-show=\"false\" class=\"container\" style=\"text-align:center\" ng-click=\"loadMore()\">\n" +
    "    <div class=\"row\"><div class=\"col-sm-12\"><button style=\"width:100%\" class=\"btn btn-default log-btn\">MORE <i class=\"fa fa-angle-down\"></i></button></div></div>\n" +
    "</div>\n" +
    "\n" +
    "<div class=\"spacing-50\"></div>");
}]);
...
angular.module("member/templates/activity.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("member/templates/activity.tpl.html",
    ...
    "                <form role=\"form\" ng-submit=\"newContent()\">\n" +
    "                    <text-angular ng-model=\"newContent.content\" ta-toolbar=\"[['p','h1','h2','bold','italics','quote','pre','insertLink', 'html']]\"></text-angular>\n" +
    "                    <button type=\"submit\" style=\"width:100%\" class=\"btn btn-default log-btn\" ng-disabled=\"!newContent.content\">create</button>\n" +
    "                </form>\n" +
    "                <div class=\"spacing-15\"></div>\n" +
...
angular.module("nav/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("nav/index.tpl.html",
    ...
    "                    <h5>Amount</h5>\n" +
    "                    <input placeholder=\"Amount\" type=\"text\" ng-model=\"newTransaction.amount\" class=\"form-control\">\n" +
    "                    <h5>Tags</h5>\n" +
...
angular.module("search/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("search/index.tpl.html",
    ...
    "		    <div class=\"card\">\n" +
    "		        <form ng-submit=\"search()\" style=\"display:flex;flex-direction:row;\">\n" +
    "		            <input style=\"border:0px;flex-grow:2;\" class=\"form-control\" type=\"text\" placeholder=\"{{searchQuery}}\" ng-model=\"searchQuery\">\n" +
    "		            <div ng-click=\"search()\" style=\"border:0px\" class=\"btn btn-default\" style=\"float:right\">\n" +
    "		                <a href=\"#\" role=\"button\">\n" +
    "		                    <h5 style=\"color:black;text-align:right\" class=\"noselect\">Search <i class=\"fa fa-search\"></i></h5>\n" +
    "		                </a>\n" +
...
angular.module("task/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("task/index.tpl.html",
    ...
    "                        <p><a ng-repeat=\"tag in task.tags.split(',') track by $index\" href=\"market/{{tag.trim()}}\">{{tag.trim()}}<span ng-show=\"!$last\">,</span></a></p>\n" +
    "                        <p><span style=\"display:inline\" ng-bind-html=\"renderContent(task.content)\"></span></p>\n" +
    "                    </div>\n" +
...
angular.module("task/tokenModal.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("task/tokenModal.tpl.html",
...
angular.module("transaction/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("transaction/index.tpl.html",
    ...
    "    </div>\n" +
    "\n" +
    "    <div class=\"card\" ng-show=\"!toggleTokenVar\">\n" +
    "        <div style=\"padding:16px\">\n" +
    "\n" +
    "            <div>\n" +
...
angular.module("work/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("work/index.tpl.html",
    ...
    "		            </a> | {{validation.validation.general}}<!-- | {{validation.validation}} -->\n" +
    "					<div class=\"spacing-10\"></div>\n" +
    "		        </div>\n" +
    "\n" +
    "			</div>\n" +
    ...
    "\n" +
    "				<div>\n" +
    "					<a href=\"market/{{work.id}}+onTime\">onTime+{{work.id}}</a>\n" +
    "					<a href=\"market/{{work.id}}+onTimeStream\">onTimeStream+{{work.id}}</a>\n" +
    "					<a href=\"market/{{work.task.id}}+onTime\">onTime+{{work.task.id}}</a>\n" +
    "				    <a href=\"market/{{work.task.id}}+onTimeStream\">onTimeStream+{{work.task.id}}</a>\n" +
    "				    <a ng-repeat=\"tag in tags\" href=\"market/{{tag.trim()}}+{{task.id}}\">{{tag.trim()}}+{{work.task.id}} </a>\n" +
