...
angular.module("content/content.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("content/content.tpl.html",
    ...
    "\n" +
    "        <h5 style=\"text-align:right;float:right\" ng-click=\"tokenToggle(post)\"><a>Tokens <i class=\"fa fa-question-circle\"></i></a></h5>\n" +
    "\n" +
    "        <div>\n" +
    ...
    "        <a style=\"padding:5px;color:grey\" ng-click=\"createReaction(post, 'plus')\"><i class=\"fa fa-angle-up\"></i> {{post.plusCount}} like </a> \n" +
    "        <a style=\"padding:5px;color:grey\" ng-click=\"createReaction(post, 'minus')\" ><i class=\"fa fa-angle-down\"></i> {{post.minusCount}} dislike </a>\n" +
    "        <a style=\"padding:5px;color:grey\" ng-click=\"reply(post)\"><i class=\"fa fa-comment-o\"></i> comment </a>\n" +
...
angular.module("content/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("content/index.tpl.html",
    ...
    "\n" +
    "						<h5 style=\"text-align:right;float:right\" ng-click=\"tokenToggle(post)\"><a href=\"#\">Tokens <i class=\"fa fa-question-circle\"></i></a></h5>\n" +
    "\n" +
    ...
    "						<a href=\"time/{{post.work.id}}\">{{post.work.amount}} {{post.work.content}}</a>\n" +
    "					</h3>\n" +
    "\n" +
...
angular.module("discover/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("discover/index.tpl.html",
    ...
    "		<div class=\"member-card\" style=\"margin-bottom:10px\" ng-click=\"\">\n" +
    ...
    "				<p><a ng-repeat=\"tag in item.tags track by $index\" href=\"market/{{tag.trim()}}\">{{tag.trim()}} </a></p>\n" +
    ...
    "				<a ng-click=\"createReaction(item, 'plus')\" ><i class=\"fa fa-angle-down\"></i> {{item.minusCount}} dislike </a>\n" +
...
angular.module("home/templates/feed.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("home/templates/feed.tpl.html",
    ...
    "                    </div>\n" +
    "                    <div class=\"card-footer\">\n" +
    "                        <a ng-click=\"$event.stopPropagation()\" href=\"task/{{item.id}}\"><i class=\"fa fa-angle-up\"></i> {{item.plusCount}} like </a> \n" +
    "                        <a ng-click=\"$event.stopPropagation()\" href=\"task/{{item.id}}\"><i class=\"fa fa-angle-down\"></i> {{item.minusCount}} dislike </a>\n" +
    "                        <a ng-click=\"reply(post);$event.stopPropagation()\"><i class=\"fa fa-comment-o\"></i> comment </a>\n" +
    ...
    "                </div>\n" +
    "\n" +
    "                <div class=\"card\" ng-if=\"item.model=='WORK'\" ng-click=\"renderToggle(item)\">\n" +
    "                    <div style=\"padding:16px;\">\n" +
    "\n" +
    "                        <div>\n" +
    "\n" +
...
angular.module("home/templates/intro.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("home/templates/intro.tpl.html",
    ...
    "                    </div>\n" +
    "                    <div class=\"card-footer\">\n" +
    "                        <a ng-click=\"createReaction(item, 'plus');$event.stopPropagation()\"><i class=\"fa fa-angle-up\"></i> {{item.plusCount}} like </a> \n" +
    "                        <a ng-click=\"createReaction(item, 'minus');$event.stopPropagation()\" ><i class=\"fa fa-angle-down\"></i> {{item.minusCount}} dislike </a>\n" +
    "                        <a ng-click=\"reply(item);$event.stopPropagation()\"><i class=\"fa fa-comment-o\"></i> comment </a>\n" +
    "                        <a ng-click=\"$event.stopPropagation()\" style=\"padding:0px\" class=\"pull-right\" href=\"content/{{item.id}}\"><i class=\"fa fa-link grey\"></i></a>\n" +
    "                    </div>\n" +
    "                    <!--TODO: NESTED -->\n" +
    "                    <div ng-show=\"item.showReply\" class=\"card-footer\" ng-click=\"$event.stopPropagation()\">\n" +
    ...
    "                        <a href=\"task/{{item.id}}\"><i class=\"fa fa-angle-up\"></i> {{item.plusCount}} like </a> \n" +
    "                        <a href=\"task/{{item.id}}\"><i class=\"fa fa-angle-down\"></i> {{item.minusCount}} dislike </a>\n" +
...
angular.module("member/templates/content.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("member/templates/content.tpl.html",
    ...
    "                </div>\n" +
    "                <div ng-click=\"$event.stopPropagation()\" ng-show=\"item.showReply\" class=\"card-footer\">\n" +
    "                    <form style=\"cursor:text;\" role=\"form\" ng-submit=\"createPost(item)\">\n" +
    "                        <text-angular ng-model=\"newPost.content\" ta-toolbar=\"[['p','h1','h2','bold','italics','quote','pre','insertLink', 'html']]\"></text-angular>\n" +
    "                        <button type=\"submit\" style=\"width:100%\" class=\"btn btn-default log-btn\" ng-disabled=\"!newPost.content\">create</button>\n" +
    "                    </form>\n" +
    "                </div>\n" +
...
angular.module("member/templates/ledger.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("member/templates/ledger.tpl.html",
    ...
    "				<p><a ng-click=\"$event.stopPropagation()\" ng-repeat=\"tag in transaction.ledger\" href=\"market/{{tag.trim()}}\">{{tag.trim()}} </a></p>\n" +
    ...
    "			</div>\n" +
    "			<div class=\"card-footer\">\n" +
    "				<a ng-click=\"$event.stopPropagation()'createReaction(transaction, 'plus')\"><i class=\"fa fa-angle-up\"></i> {{transaction.plusCount}} like </a> \n" +
    "				<a ng-click=\"$event.stopPropagation();createReaction(transaction, 'minus')\" ><i class=\"fa fa-angle-down\"></i> {{transaction.minusCount}} dislike </a>\n" +
...
angular.module("project/templates/members.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("project/templates/members.tpl.html",
    ...
    "<div class=\"row\">\n" +
    "	<div class=\"col-lg-4 col-sm-6\" ng-repeat=\"member in members\">\n" +
    "		<div class=\"member-card\" ng-click=\"renderToggle(member)\">\n" +
...
angular.module("project/templates/tasks.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("project/templates/tasks.tpl.html",
    ...
    "				</div>\n" +
    "				<div class=\"card-footer\">\n" +
    "					<a ng-click=\"$event.stopPropagation()\"><i class=\"fa fa-angle-up\"></i> {{post.plusCount}} like </a> \n" +
    "					<a ng-click=\"$event.stopPropagation()\"><i class=\"fa fa-angle-down\"></i> {{post.minusCount}} dislike </a>\n" +
...
angular.module("projects/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("projects/index.tpl.html",
    ...
    "        -->\n" +
    "\n" +
    "        <div ng-show=\"newProjectToggleVar\" class=\"card\">\n" +
    "            <div style=\"padding:16px;\">\n" +
...
angular.module("search/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("search/index.tpl.html",
    ...
    "							<div class=\"member-card card\" style=\"margin-bottom:0px\" ng-click=\"\">\n" +
    "							    <div class=\"member-card-image\" style=\"background-image: url('{{item.coverUrl}}')\">\n" +
    "							        <a href=\"member/{{item.username}}\"><img ng-src=\"{{item.avatarUrl}}\" err-src=\"/images/avatar.png\"></a>\n" +
    "							    </div>\n" +
    "							    <div class=\"member-card-info\">\n" +
...
angular.module("task/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("task/index.tpl.html",
    ...
    "                    <text-angular ng-model=\"workContent\" ta-toolbar=\"[['bold','italics','p','h1','h2','quote','pre','insertLink', 'html']]\"></text-angular>\n" +
    "                    <div class=\"spacing-5\"></div>\n" +
    ...
    "                    <p style=\"display:inline\"><i class=\"fa fa-angle-right\"></i></p>\n" +
    "                    <a style=\"display:inline;font-weight:600\" href=\"time/{{work.id}}\">{{work.amount}}</a>\n" +
    ...
    "            </div>\n" +
    "            <div class=\"card-footer\">\n" +
    "                <a ng-click=\"createReaction(work, 'plus')\"><i class=\"fa fa-angle-up\"></i> {{work.plusCount}} like </a> \n" +
    "                <a ng-click=\"createReaction(work, 'minus')\" ><i class=\"fa fa-angle-down\"></i> {{work.minusCount}} dislike </a>\n" +
    "                <a ng-click=\"reply(work)\"><i class=\"fa fa-comment-o\"></i> comment </a>\n" +
    "                <a href=\"time/{{work.id}}\"><i class=\"fa fa-check\"></i> validate </a>\n" +
    "                <a style=\"padding:0px\" class=\"pull-right\" href=\"time/{{work.id}}\"><i class=\"fa fa-link grey\"></i></a>\n" +
    "            </div>\n" +
