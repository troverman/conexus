...
angular.module("account/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("account/index.tpl.html",
    ...
    "		        	<!--CUSTOM UPLOAD DISABLED FOR NOW.. WILL BE IFPS SOON.. URL IS A LINK TO PEER FILE.. URL IS THE DATA-->\n" +
    ...
    "\n" +
    "			        <!--<br><br>-->\n" +
    "			        <!--<a ng-click=\"editAccountToggle()\" href=\"#\">-->\n" +
    "			        	<!--<p>Update <i class=\"fa fa-upload\"></i></p>-->\n" +
    "			        	<!--CUSTOM UPLOAD DISABLED FOR NOW.. WILL BE IFPS SOON.. URL IS A LINK TO PEER FILE.. URL IS THE DATA-->\n" +
    "						<!--<div ngf-accept=\"'image/*'\" ngf-drop ngf-select=\"uploadAvatar($file)\" ng-model=\"file\" class=\"drop-box\" ngf-drag-over-class=\"dragover\" ngf-allow-dir=\"true\">\n" +
...
angular.module("content/content.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("content/content.tpl.html",
    ...
    "            <i style=\"\" ng-click=\"$event.stopPropagation();tokensToggle(content);\" class=\"fa fa-ellipsis-v\"></i>\n" +
    "        </div>\n" +
    "\n" +
    "        <div>\n" +
...
angular.module("developers/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("developers/index.tpl.html",
    ...
    "                    <h5 style=\"color:white\">Developers CRE8. Developers Build. Developers Win.</h5>\n" +
    "                </div>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "    </div>-->\n" +
...
angular.module("home/templates/feed.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("home/templates/feed.tpl.html",
    ...
    "        <div ng-show=\"showOrders && positions.length == 0\" class=\"card\" ng-click=\"\">\n" +
    "\n" +
    "            <!--TODO!-->\n" +
    "\n" +
    "\n" +
    ...
    "\n" +
    "                <h4>Applications</h4>\n" +
    "                <p style=\"color:gray;font-style:italic\">PRIVACY; PRIVACY DISCOLSURE; CONSENT; RECORD ATTENTION; INFORMATION GENERALLLY</p>\n" +
    "                <p>Record Attention <a ng-click=\"informationToggle()\" href=\"#\"><i class=\"fa fa-question-circle\"></i></a><br><span style=\"font-size:10px\">Required for Attention Tokenization</span><md-switch ng-model=\"recordAttention\" aria-label=\"Record Attention\"></md-switch></p>\n" +
    "                <p>Location Tracking <a ng-click=\"informationToggle()\" href=\"#\"><i class=\"fa fa-question-circle\"></i></a><br><span style=\"font-size:10px\">Required for Location Tokenization</span><md-switch ng-model=\"gpsTracking\" aria-label=\"GPS Tracking\"></md-switch></p>\n" +
    "\n" +
    ...
    "                                <a style=\"color:gray;\"><span style=\"color:gray\"></span><i class=\"fa fa-ellipsis-v\"></i></a>\n" +
    "                            </p>\n" +
    "\n" +
    "                            <div style=\"clear:both\"></div>\n" +
    "\n" +
    ...
    "                            <!--<span style=\"display:inline\" ng-bind-html=\"renderContent(item.content)\"></span>-->\n" +
    "                            <!--mmm-->\n" +
    "                            <div ta-bind ng-model=\"item.content\"></div>\n" +
    "                        </div>\n" +
    "                    </div>\n" +
    "                    <div class=\"card-footer\">\n" +
    "                        <a ng-click=\"$event.stopPropagation();createReaction(item, 'plus')\"><i class=\"fa fa-angle-up\"></i> {{item.reactions.plus}} like </a> \n" +
...
angular.module("member/templates/activity.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("member/templates/activity.tpl.html",
    ...
    "                        <!--<span ng-repeat=\"(key, value) in item.amountSet\"><span style=\"font-weight:800\">{{value}} <a ng-click=\"$event.stopPropagation();\" href=\"market/{{key}}\">{{key}}</a></span></span>-->\n" +
    "                    </div>\n" +
    "\n" +
    "                    <div style=\"display:inline\">\n" +
...
angular.module("member/templates/content.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("member/templates/content.tpl.html",
    ...
    "                    </div>\n" +
    "\n" +
    "                    <h3 ng-if=\"item.title\"><a href=\"content/{{item.id}}\">{{item.title}}</a></h3>\n" +
    "\n" +
...
angular.module("member/templates/ledger.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("member/templates/ledger.tpl.html",
    ...
    "                    <span ng-if=\"transaction.from.username\"><a ng-click=\"$event.stopPropagation()\" href=\"member/{{transaction.from.username}}\">{{transaction.from.username}}</a> <i class=\"fa fa-arrow-right\"></i></span>\n" +
    "                    <span ng-if=\"transaction.from.title\"><a ng-click=\"$event.stopPropagation()\" href=\"project/{{transaction.from.title}}\">{{transaction.from.title}}</a> <i class=\"fa fa-arrow-right\"></i></span>\n" +
    "                    <span ng-if=\"transaction.to.username\"> <a ng-click=\"$event.stopPropagation()\" href=\"member/{{transaction.to.username}}\">{{transaction.to.username}}</a></span>\n" +
    "                    <span ng-if=\"transaction.to.title\"> <a ng-click=\"$event.stopPropagation()\" href=\"project/{{transaction.to.urlTitle}}\">{{transaction.to.title}}</a></span>\n" +
    "                </p>-->\n" +
    "\n" +
    "                <div style=\"display:inline\">\n" +
    "                    <span ng-if=\"item.from.username\">\n" +
...
angular.module("member/templates/positions.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("member/templates/positions.tpl.html",
    ...
    "                    </div>  \n" +
    "\n" +
    "	            	<span ng-repeat=\"asset in item.amountSet track by $index\">\n" +
    "						{{item.amountSet[$index]}} <a ng-click=\"$event.stopPropagation()\" href=\"market/{{item.identiferSet[$index]}}\">{{item.identiferSet[$index]}}</a> \n" +
    "					</span>\n" +
    "					<span> | </span>\n" +
    "					<span ng-repeat=\"asset in item.amountSet1 track by $index\">\n" +
    "						{{item.amountSet1[$index]}} <a ng-click=\"$event.stopPropagation()\" href=\"market/{{item.identiferSet1[$index]}}\">{{item.identiferSet1[$index]}}</a> \n" +
    "					</span>\n" +
    "\n" +
    "					<p style=\"display:inline;font-size:10px;color:gray;margin-left:5px\" am-time-ago=\"item.createdAt\"></p>\n" +
    "	            </div>\n" +
...
angular.module("nav/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("nav/index.tpl.html",
    ...
    "    <md-sidenav class=\"md-sidenav-right md-whiteframe-z2\" md-component-id=\"cardDetail\" md-is-locked-open=\"false\" style=\"position:fixed;background-color:white;max-width:100%\">\n" +
    ...
    "            <div style=\"padding:16px\">\n" +
    "                <div class=\"spacing-15\"></div>\n" +
    "                <h4 class=\"nav-links\"><a href=\"project/{{project.urlTitle}}/content\">Information</a></h4>\n" +
    "                <h4 class=\"nav-links\"><a href=\"project/{{project.urlTitle}}/content\">Associations</a></h4>\n" +
    "                <h4 class=\"nav-links\"><a href=\"project/{{project.urlTitle}}/content\">Reactions</a></h4>\n" +
    "                <h4 class=\"nav-links\"><a href=\"project/{{project.urlTitle}}/content\">Tokens</a></h4>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "    </md-sidenav>\n" +
    "\n" +
    ...
    "            </ul>-->\n" +
    "\n" +
    "            <!--VIEW TOKEN.. RECORIND ACTIONS ON CREATE-->\n" +
    "            <div ng-if=\"recordActions\" style=\"float:left;margin-top:13px;margin-right:15px;font-size:18px\">\n" +
    ...
    "            <div ng-if=\"taskTime\" class=\"nav-links\" style=\"float:left;margin-top:13px;margin-right:15px;font-size:18px\">\n" +
...
angular.module("project/templates/about.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("project/templates/about.tpl.html",
    ...
    "            <div class=\"spacing-5\"></div>\n" +
    "\n" +
    "            <p ng-if=\"project.location\"><b>Location</b></p>\n" +
...
angular.module("project/templates/ledger.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("project/templates/ledger.tpl.html",
    ...
    "                <div style=\"display:inline;padding-left:5px;padding-right:5px;\">\n" +
    "                    <i class=\"fa fa-arrow-right\"></i>\n" +
    "                    <!--<span ng-repeat=\"(key, value) in transaction.amountSet\"><span style=\"font-weight:800\">{{value}} <a ng-click=\"$event.stopPropagation();\" href=\"market/{{key}}\">{{key}}</a></span></span>-->\n" +
    "                </div>\n" +
    "\n" +
    "                <div style=\"display:inline\">\n" +
...
angular.module("project/templates/tasks.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("project/templates/tasks.tpl.html",
    ...
    "				<div style=\"padding:16px;\">\n" +
    "					<div style=\"float:right;text-align:right\">\n" +
    "                    	<a ng-click=\"$event.stopPropagation();renderValidationToggle(task);\"><span style=\"color:gray\"><i class=\"fas fa-bezier-curve\"></i></span></a>\n" +
    "                    	<a ng-click=\"$event.stopPropagation();tokensToggle(task)\"><span style=\"color:gray\"><i class=\"fa fa-ellipsis-v\"></i></span></a>\n" +
    "                    </div>\n" +
    "					<h4 ng-click=\"$event.stopPropagation()\"><a href=\"task/{{task.id}}\">{{task.title}}</a></h4>\n" +
    "					<!--<p ng-click=\"$event.stopPropagation()\"><a href=\"project/{{task.project.urlTitle}}\">{{task.project.title}}</a></p>-->\n" +
...
angular.module("projects/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("projects/index.tpl.html",
    ...
    "            <li style=\"float:left;font-size:14px\"><a href=\"#\" ng-click=\"filterToggle('DISCOVER', filterSet)\"><i class=\"fa fa-filter\"></i> Filter</a></li>\n" +
    "            <li style=\"float:left;font-size:14px\"><a href=\"#\" ng-click=\"getLatLng()\"><i class=\"fa fa-map-marker\"></i> Location</a></li>\n" +
    "            <li ng-if=\"currentUser\" style=\"float:left;font-size:14px\"><a href=\"#\" ng-click=\"\"><i class=\"fas fa-project-diagram\"></i> My Projects</a></li>\n" +
    "            <div style=\"clear:both\"></div>\n" +
    "        </ul>\n" +
    "\n" +
    "        <div class=\"card\">\n" +
    ...
    "\n" +
    "        <div ng-repeat=\"project in projects\">\n" +
    "            <div class=\"card\" ng-click=\"renderToggle(project)\">\n" +
    "                <div style=\"padding:16px;\">\n" +
    "                    <div class=\"row\">\n" +
    "                        <div class=\"col-sm-1 col-xs-2\">\n" +
...
angular.module("task/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("task/index.tpl.html",
    "<style>\n" +
    "    .toast-success {background-color: #002c54;}\n" +
    "</style>\n" +
    "<div class=\"container\">\n" +
    "\n" +
    "    <div class=\"spacing-10\"></div>\n" +
...
angular.module("time/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("time/index.tpl.html",
    ...
    "	</div>\n" +
    "\n" +
    "	<!--{toolbarButtons:['bold', 'italic', 'underline', 'formatOL', 'htmlUntouched', 'colorsText', 'fileUploadURL', 'videoUploadtable', 'InsertMaxSize']}-->\n" +
    "\n" +
    "    <!--\n" +
    "    <div class=\"spacing-5\"></div>\n" +
    "	<div class=\"row\">\n" +
    ...
    "				<div ng-show=\"item.showReply\" class=\"card-footer\">\n" +
    "					<form role=\"form\" ng-submit=\"newContent(item)\">\n" +
    "						<textarea froala=\"froalaOptions\" ng-model=\"newContent.content\"></textarea>\n" +
    "						<!--<text-angular ng-model=\"newContent.content\" ta-toolbar=\"[['p','h1','h2','bold','italics','quote','pre','insertLink', 'html']]\"></text-angular>-->\n" +
    "						<button type=\"submit\" style=\"width:100%\" class=\"btn btn-default log-btn\" ng-disabled=\"!newContent.content\">create</button>\n" +
    "					</form>\n" +
    "				</div>\n" +
...
angular.module("validation/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("validation/index.tpl.html",
    ...
    "\n" +
    "				<div style=\"float:right;text-align:right\">\n" +
    "	                <a style=\"color:gray;\" ng-click=\"$event.stopPropagation();renderValidationToggle(validation)\"><span style=\"color:gray\"></span><i class=\"fas fa-bezier-curve\"></i></a>\n" +
    "	                <a style=\"color:gray;\" ng-click=\"$event.stopPropagation();tokensToggle(validation)\"><span style=\"color:gray\"></span><i class=\"fa fa-ellipsis-v\"></i></a>\n" +
    "	            </div>\n" +
    "\n" +
    "				<!--TODO-->\n" +
    "				<!--\n" +
