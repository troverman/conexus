...
angular.module("home/index.tpl.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("home/index.tpl.html",
    ...
    "					<p><a href=\"/task/{{task.id}}\"><span class=\"\">{{task.title}}</span></a> | <a href=\"/project/{{task.project.urlTitle}}\"><span class=\"\">{{task.project.title}}</span></a></p>\n" +
    "					<p>{{task.content}}</p>\n" +
    "					<br>\n" +
    "				</div>\n" +
    "				<div class=\"\" style=\"padding: 8px 16px 8px;background-color: #f9f9f9\">\n" +
    ...
    "					<a style=\"color:grey\" class=\"pull-right\" href=\"task/{{task.id}}\"><i class=\"fa fa-link grey\"></i></a>\n" +
    "				</div>\n" +
    "			</md-card>\n" +
    "\n" +
    ...
    "	                <div><span style=\"display:inline\" ng-bind-html=\"renderMessage(work.content)\"></span></div>\n" +
    ...
    "	<!--\n" +
    "	<div class=\"container\">\n" +
    "	    <md-card ng-repeat=\"project in projects.slice(0,15)\">\n" +
    "			<md-card-title>\n" +
    "				<md-card-title-text>\n" +
    "					<div>\n" +
    "						<a style=\"display:inline\" href=\"/projects/{{project.urlTitle}}\">{{project.title}}</a>\n" +
    "					</div>\n" +
    "				</md-card-title-text>\n" +
    "			</md-card-title>\n" +
    "		</md-card>\n" +
...
angular.module("task/index.tpl.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("task/index.tpl.html",
    ...
    "    <div>\n" +
    "        <h3>{{taskTime}}</h3>\n" +
    "        <!--<p>{{(taskTime / totalTime)*task.timeBountySet}}></p>-->\n" +
    ...
    "        <!--<button ng-show=\"working\" type=\"submit\" class=\"btn btn-default log-btn\" ng-click=\"start()\">Start Stream</button>-->\n" +
    ...
    "                        <a style=\"display:inline\" href=\"/member/{{post.user.username}}\"><span class=\"\">{{post.user.username}}</span></a>\n" +
    "                        <p style=\"display:inline\"><i class=\"fa fa-angle-right\"></i></p>\n" +
    "                        <a style=\"display:inline\" href=\"task/{{post.task.id}}\"><span class=\"\">{{post.task.title}}</span></a>\n" +
    "                    </div>\n" +
    "                    <div><span style=\"display:inline\" ng-bind-html=\"renderMessage(post.content)\"></span></div>\n" +
    "                </md-card-title-text>\n" +
    "            </md-card-title>\n" +
...
angular.module("tasks/index.tpl.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("tasks/index.tpl.html",
    ...
    "			<tr ng-repeat=\"task in tasks\">\n" +
    "				<!--<td>\n" +
    "					<a href=\"task/{{task.id}}\"><button type=\"submit\" class=\"btn btn-default log-btn\"><i class=\"fa fa-angle-up\"></i></button></a>\n" +
    "					<a href=\"task/{{task.id}}\"><button type=\"submit\" class=\"btn btn-default log-btn\"><i class=\"fa fa-angle-down\"></i></button></a>\n" +
    "				</td>-->\n" +
