...
angular.module("about/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("about/index.tpl.html",
    ...
    "					<div class=\"row\">\n" +
    "						<div class=\"col-md-8\">\n" +
    "							<h2><a style=\"color:white;margin:0px\" href=\"/market\" ui-sref=\"market\">Multidimensional Value Exchange</a></h2>\n" +
    ...
    "				<p style=\"font-style:italic;color:gray;margin:0px\">Create relationships in the <a href=\"/market\" ui-sref=\"market\"><b>Multidimensional Token Market</b></a>.</p> \n" +
    "				<div class=\"spacing-50\"></div>\n" +
    "			</div>\n" +
    "			<div class=\"col-md-4\">\n" +
    "			</div>\n" +
...
angular.module("account/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("account/index.tpl.html",
    ...
    "                    <p><a href=\"/member/{{currentUser.username}}/projects\" ui-sref=\"member.projects({path:currentUser.username})\">{{currentUser.projectCount || 0}} Projects</a> | <a href=\"/member/{{currentUser.username}}/followers\" ui-sref=\"member.followers({path:currentUser.username})\">{{currentUser.followerCount || 0}} Followers</a> | <a href=\"/member/{{currentUser.username}}/following\" ui-sref=\"member.following({path:currentUser.username})\">{{currentUser.followingCount || 0}} Following</a>\n" +
    "\n" +
    "					<div class=\"row\">\n" +
    "						<div class=\"col-xs-12\">\n" +
    "							<h5>Balance Mapping Lookup <span style=\"font-size:11px;color:gray\"></span></h5>\n" +
...
angular.module("action/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("action/index.tpl.html",
    ...
    "                <a ng-click=\"$event.stopPropagation();createReaction(action, 'plus')\"><i class=\"fa fa-angle-up\"></i> {{action.reactions.plus}} like </a> \n" +
    "                <a ng-click=\"$event.stopPropagation();createReaction(action, 'minus')\" ><i class=\"fa fa-angle-down\"></i> {{action.reactions.minus}} dislike </a>\n" +
...
angular.module("association/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("association/index.tpl.html",
    ...
    "			            	</h1>\n" +
    "			            	<h5 style=\"color:white\">Association</h5>\n" +
    "			            </div>\n" +
    "			        </div>\n" +
    "			    </div>\n" +
    "			</div>\n" +
    "			<div style=\"padding:16px\">\n" +
    "				<div style=\"float:right;text-align:right\">\n" +
    "	                <a style=\"color:gray;\" ng-click=\"$event.stopPropagation();cardDetailToggle(association)\"><span style=\"color:gray\"></span><i class=\"fa fa-ellipsis-v\"></i></a>\n" +
    "	            </div>\n" +
    "				<div class=\"spacing-5\"></div>\n" +
    ...
    "							<th>Charter Rules <a ng-click=\"informationToggle('PROJECTCHARTER')\"><i class=\"fa fa-question-circle\"></i></a></th>\n" +
    "							<th>Weighted Validation Score(s) <a ng-click=\"informationToggle('REPUTATIONWEIGHTEDVALIDATIONSCORE')\"><i class=\"fa fa-question-circle\"></i></a></th>\n" +
    "						</tr>\n" +
    "					</thead>\n" +
    "					<tbody>\n" +
    ...
    "			</div>\n" +
    "			<div class=\"card-footer\">\n" +
    "				<a ng-click=\"createReaction(validation, 'plus')\"><i class=\"fa fa-angle-up\"></i> {{association.reactions.plus}} like </a> \n" +
    "                <a ng-click=\"createReaction(validation, 'minus')\" ><i class=\"fa fa-angle-down\"></i> {{association.reactions.minus}} dislike </a>\n" +
...
angular.module("contentList/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("contentList/index.tpl.html",
    ...
    "                        <a ng-click=\"$event.stopPropagation();\" class=\"pull-right\" style=\"padding:0px;\" href=\"content/{{item.id}}\" ui-sref=\"content({id:item.id})\"><i class=\"fa fa-link grey\"></i></a>\n" +
    "                    </div>\n" +
...
angular.module("discover/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("discover/index.tpl.html",
    ...
    "						<a ng-click=\"$event.stopPropagation();createReaction(item, 'plus')\"><i class=\"fa fa-angle-up\"></i> {{item.reactions.plus}} like </a> \n" +
    "						<a ng-click=\"$event.stopPropagation();createReaction(item, 'minus')\" ><i class=\"fa fa-angle-down\"></i> {{item.reactions.minus}} dislike </a>\n" +
    "						<a ng-click=\"$event.stopPropagation();reply(item)\" href=\"task/{{item.id}}\" ui-sref=\"task({id:item.id})\"><i class=\"fa fa-comment-o\"></i> comment </a>\n" +
    "						<a ng-click=\"$event.stopPropagation();reply(item)\" href=\"task/{{item.id}}\" ui-sref=\"task({id:item.id})\" style=\"padding:0px\" class=\"pull-right\"><i class=\"fa fa-link grey\"></i></a>\n" +
    "					</div>\n" +
    "				</div>\n" +
    ...
    "	                    <a ng-click=\"$event.stopPropagation();reply(item)\"><i class=\"fa fa-comment-o\"></i> comment </a>\n" +
    "	                    <a class=\"pull-right\" style=\"padding:0px;\" href=\"transaction/{{item.id}}\" ui-sref=\"transaction({id:item.id})\"><i class=\"fa fa-link grey\"></i></a>\n" +
    "	                </div>\n" +
    "	            </div>\n" +
    "			</div>\n" +
    "		</div>\n" +
...
angular.module("home/templates/feed.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("home/templates/feed.tpl.html",
    ...
    "<div class=\"container\">\n" +
    "\n" +
    "    <!--TODO: DYNAMIC TUTORIAL.....-->\n" +
    "    <div class=\"row\" ng-if=\"isTutorial\">\n" +
    "\n" +
    "        <!--IF NOT INFO-->\n" +
    "        <div ng-show=\"pageNumber == 0\" class=\"card\">\n" +
    ...
    "                                <p style=\"color:gray\"><b>Total Reputation</b>: {{currentUser.totalWork}}</p>\n" +
    "                                <p style=\"color:gray\">{{currentUser.id}}<img style=\"height:50px;text-align:left\" ng-src=\"https://chart.googleapis.com/chart?chs=250x250&cht=qr&chl={{currentUser.id}}\"></p>\n" +
    "                            </div>\n" +
    ...
    "                                        <h1 style=\"text-align:left;font-size:35px;color:rgba(255,255,255,0.9);font-weight:400;\">Information</h1>\n" +
    "                                        <h5><a style=\"color:white\" href=\"/account\"  ui-sref=\"account\"><i class=\"fas fa-passport\"></i> Account Settings</a></h5>\n" +
    "                                    </div>\n" +
    "                                </div>\n" +
    "                            </div>\n" +
    "                            <div style=\"padding:16px;\">\n" +
    ...
    "            <!--\n" +
    "            <div class=\"card\">\n" +
    "                <div style=\"background:url('https://source.unsplash.com/1600x900/?details,notes,exolire,wonder,value,science,forest,code');min-height:50px\" class=\"imageContainerSmall\">\n" +
    "                    <div style=\"background:rgba(0,0,0,0.75);height:50px\" class=\"imageContainerSmallDiv\">  \n" +
    "                        <div style=\"margin-top: auto;margin-bottom: auto;\">\n" +
    "                            <div class=\"container\">\n" +
    "                                <h1 style=\"text-align:left;font-size:20px;color:rgba(255,255,255,0.9);font-weight:400;\"><i class=\"fas fa-user\"></i> Balance and Reputation</h1>\n" +
    "                            </div>\n" +
    "                        </div>\n" +
    "                    </div>\n" +
    "                </div>\n" +
    ...
    "                        <div style=\"margin-top: auto;margin-bottom: auto;\">\n" +
    "                            <div class=\"container\">\n" +
    "                                <h1 style=\"text-align:left;font-size:20px;color:rgba(255,255,255,0.9);font-weight:400;\"><i class=\"fas fa-eye\"></i> 24hr Summary & Upcoming</h1>\n" +
    "                            </div>\n" +
    "                        </div>\n" +
    "                    </div>\n" +
    "                </div>\n" +
    ...
    "                        <div style=\"margin-top: auto;margin-bottom: auto;\">\n" +
    "                            <div class=\"container\">\n" +
    "                                <h1 style=\"text-align:left;font-size:20px;color:rgba(255,255,255,0.9);font-weight:400;\"><i class=\"fas fa-globe\"></i> My Value Map</h1>\n" +
    "                            </div>\n" +
    "                        </div>\n" +
    "                    </div>\n" +
    "                </div>\n" +
    ...
    "                        <a href=\"#\" ng-click=\"filterContent(tag.element)\"><b>{{association.element}}</b></a>\n" +
    "                    </div>\n" +
    "                </div>\n" +
    "            </div>\n" +
    ...
    "                <li ng-if=\"currentUser\" style=\"float:left;font-size:14px\"><a href=\"member/{{currentUser.username}}/followers\" ng-click=\"getMyFollowers()\"><i class=\"fa fa-users\"></i> Following</a></li>\n" +
    "                <li ng-if=\"currentUser\" style=\"float:left;font-size:14px\"><a href=\"member/{{currentUser.username}}/projects\" ng-click=\"getMyProjects()\"><i class=\"fas fa-project-diagram\"></i> My Projects</a></li>\n" +
    "                <li ng-if=\"currentUser\" style=\"float:left;font-size:14px\"><a href=\"member/{{currentUser.username}}/positions\" ui-sref=\"member.positions({path:currentUser.username})\" ng-click=\"getMyProjects()\"><i class=\"fas fa-globe\"></i> My Value Map</a></li>\n" +
    "\n" +
    "                <li ng-click=\"expandSort()\" style=\"float:right;font-size:14px\"><a href=\"#\">Sort By Recent <i class=\"fa fa-angle-down\"></i></a></li>\n" +
    "                <div style=\"clear:both\"></div>\n" +
    "            </ul>\n" +
    ...
    "\n" +
    "\n" +
    "            <!--TODO: UNIFY HEADER.. 100px.. 35px font-->\n" +
    "            <div ng-repeat=\"item in activity\">\n" +
    ...
    "                        <div>\n" +
    "\n" +
    "                            <!--TODO: ASSOCIATION AREA-->\n" +
    "                            <div style=\"float:right;text-align:right\">\n" +
    "                                <a style=\"color:gray;\" ng-click=\"$event.stopPropagation();cardDetailToggle(item)\"><span style=\"color:gray\"></span><i class=\"fa fa-ellipsis-v\"></i></a>\n" +
    "                            </div>\n" +
    "\n" +
    "                            <a ng-click=\"$event.stopPropagation()\" style=\"display:inline;font-weight:600;margin-left:5px\" href=\"member/{{item.user.username}}\" ui-sref=\"member.activity({path:item.user.username})\">\n" +
    "                                <img ng-click=\"$event.stopPropagation()\" class=\"card-avatar\" ng-src=\"{{item.user.avatarUrl}}\" err-src=\"/images/avatar.png\">\n" +
    "                                {{item.user.username}}\n" +
    "                            </a>\n" +
    "                            \n" +
    "                            <p style=\"font-size:10px;color:gray;margin-left:42px\" am-time-ago=\"item.createdAt\"></p>\n" +
    ...
    "                                <a ng-click=\"$event.stopPropagation();\" href=\"project/{{item.urlTitle}}\" ui-sref=\"project.activity({path:item.urlTitle})\"><img style=\"width:50px;height:50px;max-width:1000%\" ng-src=\"{{item.avatarUrl}}\" err-src=\"/images/avatar.png\"></a>\n" +
    "                            </div>\n" +
    ...
    "                                    <span ng-if=\"item.location\" style=\"color:gray\"></span>\n" +
    "                                </p>\n" +
    "                                <h3 style=\"margin-top:0px\"><a ng-click=\"$event.stopPropagation();\" href=\"project/{{item.urlTitle}}\" ui-sref=\"project.activity({path:item.urlTitle})\">{{item.title}}</a></h3>\n" +
    "                                <div style=\"overflow:scroll\">\n" +
    "                                    <span style=\"display:inline\" ng-bind-html=\"renderContent(item.description)\"></span>\n" +
    "                                </div>\n" +
    "                            </div>\n" +
    ...
    "                            <div style=\"margin-top: auto;margin-bottom: auto;\">\n" +
    "                                <div class=\"container\" style=\"width:100%\">>\n" +
    "                                    <h1 style=\"text-align:left;font-size:35px;color:rgba(255,255,255,0.9);font-weight:400;\"><a style=\"color:white\" ng-click=\"$event.stopPropagation()\" href=\"task/{{item.id}}\" ui-sref=\"task({id:item.id})\">{{item.title}}</h1>\n" +
    ...
    "                            <a ng-click=\"$event.stopPropagation()\" ng-repeat=\"tag in item.task.tags\" href=\"market/{{tag.trim()}}+{{task.id}}\" ui-sref=\"market({id:tag.trim()})\">{{tag.trim()}} </a>\n" +
    "                        </p>\n" +
    "\n" +
    "                        <div style=\"margin-left:42px\"><span style=\"display:inline\" ng-bind-html=\"renderContent(item.content)\"></span></div>\n" +
    "\n" +
    ...
    "                        <a ng-click=\"$event.stopPropagation();reply(item)\"><i class=\"fa fa-comment-o\"></i> comment </a>\n" +
    "                        <a ng-click=\"$event.stopPropagation();validationToggle(item)\"><i class=\"fa fa-check\"></i> validate </a>\n" +
    "                        <a ng-click=\"$event.stopPropagation()\" style=\"padding:0px\" class=\"pull-right\" href=\"time/{{item.id}}\" ui-sref=\"time({id:item.id})\"><i class=\"fa fa-link grey\"></i></a>\n" +
    "                    </div>\n" +
    "                    <div ng-show=\"item.showReply\" class=\"card-footer\">\n" +
    "                        <form role=\"form\" ng-submit=\"createContent(item)\">\n" +
...
angular.module("home/templates/intro.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("home/templates/intro.tpl.html",
    ...
    "                -->\n" +
    "                <p style=\"font-style:italic;margin:0px;color:gray\">The <a href=\"/transparency\" ui-sref=\"transparency\"><b>Decentralized Network</b></a> is you! Decentralized peers support the network.</p>\n" +
    ...
    "                            <a style=\"color:gray;\" ng-click=\"$event.stopPropagation();cardDetailToggle(item)\"><span style=\"color:gray\"></span><i class=\"fa fa-ellipsis-v\"></i></a>\n" +
    "                        </div>\n" +
    "                        <p ng-click=\"$event.stopPropagation()\"><a ng-repeat=\"tag in item.tags track by $index\" href=\"market/{{tag.trim()}}\" ui-sref=\"market({id:tag.trim()})\">{{tag.trim()}} </a></p>\n" +
    ...
    "                        <a ng-click=\"$event.stopPropagation();reply(item)\"><i class=\"fa fa-comment-o\"></i> comment </a>\n" +
    "                        <a ng-click=\"$event.stopPropagation();validationToggle(item)\"><i class=\"fa fa-check\"></i> validate </a>\n" +
    "                        <a style=\"padding:0px\" class=\"pull-right\" href=\"task/{{item.id}}\" ui-sref=\"task({id:item.id})\"><i class=\"fa fa-link grey\"></i></a>\n" +
    "                    </div>\n" +
    "                </div>\n" +
    "\n" +
    "                <div class=\"card\" ng-if=\"item.model=='TIME'\" ng-click=\"cardDetailToggle(item)\">\n" +
    ...
    "                            <div style=\"margin-top: auto;margin-bottom: auto;\">\n" +
    "                                <div style=\"padding:15px\">\n" +
    "                                    <h1 style=\"text-align:left;font-size:35px;color:rgba(255,255,255,0.9);font-weight:400;\"><a style=\"color:white\" ng-click=\"$event.stopPropagation()\"href=\"task/{{item.id}}\">{{item.amount}}</h1>\n" +
    "                                    <h5 style=\"color:white\" am-time-ago=\"item.createdAt\"></h5>\n" +
    "                                </div>\n" +
    "                            </div>\n" +
    "                        </div>\n" +
    "                    </div>\n" +
    ...
    "                            <a ng-repeat=\"tag in item.task.tags\" href=\"market/{{tag.trim()}}+{{task.id}}\" ui-sref=\"market({id:tag.trim()})\">{{tag.trim()}} </a>\n" +
    "                        </p>\n" +
    "                        <div style=\"margin-left:42px\"><span style=\"display:inline\" ng-bind-html=\"renderContent(item.content)\"></span></div>\n" +
    "                    </div>\n" +
    "                    <div class=\"card-footer\">\n" +
...
angular.module("market/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("market/index.tpl.html",
    ...
    "			    <div class=\"card\" ng-repeat=\"market in markets\" ng-click=\"cardDetailToggle(market)\">\n" +
    ...
    "					        <div style=\"margin-top: auto;margin-bottom: auto;\">\n" +
    "					        	<div class=\"container\">\n" +
    "						            <h1 style=\"text-align:left;font-size:30px;color:rgba(255,255,255,0.9);font-weight:400;\"><a style=\"color:white\" ng-click=\"$event.stopPropagation();\" href=\"market/{{stateParams.id}}/{{market.string}}\" ui-sref=\"marketPair({ setAlpha: stateParams.id, setBeta:market.string })\">{{market.string}}</a></h1>\n" +
...
angular.module("marketPair/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("marketPair/index.tpl.html",
    ...
    "            <li ng-click=\"selectTab('MANIFOLDS')\"><a href=\"#\">Manifold Actions</a></li><!--ACTIONS ON ITEMS (eyes) protocols .. what manifolds in a market-->\n" +
...
angular.module("marketPlace/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("marketPlace/index.tpl.html",
    ...
    "		        <div class=\"card\" ng-click=\"cardDetailToggle(item)\">\n" +
    "		        	<div ng-click=\"$event.stopPropagation();cardDetailToggle(item)\" style=\"background:url('https://source.unsplash.com/1600x900/?{{item.tags}}');min-height:100px\" class=\"imageContainerSmall\">\n" +
    "		                <div style=\"background:rgba(0,0,0,0.75);height:100px\" class=\"imageContainerSmallDiv\">  \n" +
    "		                    <div style=\"margin-top: auto;margin-bottom: auto;\">\n" +
    "		                        <div class=\"container\">\n" +
...
angular.module("markets/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("markets/index.tpl.html",
    ...
    "				        <div style=\"margin-top: auto;margin-bottom: auto;\">\n" +
    "				        	<div class=\"container\">\n" +
    "					            <h1 style=\"text-align:left;font-size:35px;color:rgba(255,255,255,0.9);font-weight:400;\"><a ng-click=\"$event.stopPropagation();\" href=\"market/{{token.string}}\" style=\"color:white\" ui-sref=\"market({id:token.string})\">{{token.string}}</a></h1>\n" +
    "					        </div>\n" +
    "				        </div>\n" +
    "				    </div>\n" +
    "				</div>\n" +
    ...
    "\n" +
    "                    <!--LOL-->\n" +
    "                    <img style=\"border-radius:100%;height:64px;padding-right:5px;\" ng-src=\"http://identicon-1132.appspot.com/{{token.string.split('+').join('')}}?s=8&p=8&f=png\">\n" +
    "                   \n" +
    "                    <div class=\"spacing-10\"></div>\n" +
    ...
    "				    <p style=\"color:gray\">Protocols: {{token.protocols}}</p>\n" +
    "			    	<!--\n" +
...
angular.module("member/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("member/index.tpl.html",
    ...
    "			</div>\n" +
    "			<div class=\"container\">\n" +
    "				<div class=\"pull-left\"><a ng-click=\"$event.stopPropagation()\" href=\"member/{{member.username}}\" ui-sref=\"member.activity\"><img class=\"avatar\" err-src=\"/images/avatar.png\" ng-src=\"{{member.avatarUrl}}\"/></a></div>\n" +
...
angular.module("member/templates/actions.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("member/templates/actions.tpl.html",
    ...
    "                    <div style=\"margin-top: auto;margin-bottom: auto;\">\n" +
    "                        <div style=\"padding:15px\">\n" +
    "                            <h1 style=\"text-align:left;font-size:35px;color:rgba(255,255,255,0.9);font-weight:400;\"><a style=\"color:white\" ng-click=\"$event.stopPropagation();\" href=\"action/{{item.associatedModels[0].id}}\" ui-sref=\"member.actions({id:item.associatedModels[0].id})\"> {{item.type}} {{item.amount}} {{item.associatedModels[0].title}}</a></h1>\n" +
    "                        </div>\n" +
    "                    </div>\n" +
    "                </div>\n" +
    "            </div>\n" +
    ...
    "                <div class=\"spacing-5\"></div>\n" +
    "\n" +
    "                <h5>{{item.type}} | {{item.amount}} | <a href=\"item/{{item.associatedModels[0].id}}\" ui-sref=\"item({id:item.associatedModels[0].id})\">{{item.associatedModels[0].title}}</a></h5>\n" +
    "\n" +
    "            </div>\n" +
    "            <div class=\"card-footer\">\n" +
    "                <a ng-click=\"$event.stopPropagation();createReaction(item, 'plus')\"><i class=\"fa fa-angle-up\"></i> {{item.reactions.plus}} like </a> \n" +
    "                <a ng-click=\"$event.stopPropagation();createReaction(item, 'minus')\" ><i class=\"fa fa-angle-down\"></i> {{item.reactions.minus}} dislike </a>\n" +
    "                <a ng-click=\"$event.stopPropagation();reply(item)\"><i class=\"fa fa-comment-o\"></i> comment </a>\n" +
    "                <a ng-click=\"$event.stopPropagation();\" class=\"pull-right\" style=\"padding:0px;\" href=\"action/{{item.id}}\" ui-sref=\"action({id:item.id})\"><i class=\"fa fa-link grey\"></i></a>\n" +
    "            </div>\n" +
    "            <div ng-show=\"item.showReply\" class=\"card-footer\">\n" +
    "	            <form role=\"form\" ng-submit=\"createContent(item)\">\n" +
    "	                <text-angular ng-model=\"newContent.content\" ta-toolbar=\"[['p','h1','h2','bold','italics','quote','pre','insertLink', 'html']]\"></text-angular>\n" +
...
angular.module("member/templates/activity.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("member/templates/activity.tpl.html",
    ...
    "                    <div ng-click=\"$event.stopPropagation()\">\n" +
    "\n" +
    "                        <a style=\"display:inline;font-weight:600;margin-left:5px\" href=\"member/{{item.user.username}}\" ui-sref=\"member.activity({id:item.user.username})\">\n" +
    "                            <img class=\"card-avatar\" ng-src=\"{{item.user.avatarUrl}}\" src=\"{{item.user.avatarUrl}}\" err-src=\"/images/avatar.png\">\n" +
    "                            {{item.user.username}}\n" +
    "                        </a>\n" +
    "\n" +
    ...
    "                    </div>\n" +
    "\n" +
    "                    <p ng-click=\"$event.stopPropagation()\" ng-show=\"item.task.tags.split(',') > 0\" style=\"margin-left:42px\"><a ng-repeat=\"tag in item.task.tags.split(',')\" href=\"market/{{tag.trim()}}\">{{tag.trim()}} </a></p>\n" +
    "\n" +
    "                    <div style=\"margin-left:42px\"><span style=\"display:inline\" ng-bind-html=\"renderContent(item.content)\"></span></div>\n" +
    "                    \n" +
    "                </div>\n" +
    ...
    "                    <div style=\"display:inline\">\n" +
    "                        <span ng-if=\"item.from.username\">\n" +
    "                            <a ng-click=\"$event.stopPropagation()\"  style=\"display:inline;font-weight:600;margin-left:5px\" href=\"member/{{item.from.username}}\" ui-sref=\"member.activity({id:item.from.username})\">\n" +
    "                                <img class=\"card-avatar\" ng-src=\"{{item.from.avatarUrl}}\" src=\"{{item.from.avatarUrl}}\" err-src=\"/images/avatar.png\">\n" +
    "                                {{item.from.username}}\n" +
    "                            </a>\n" +
    "                        </span>\n" +
    "                        <span ng-if=\"item.from.title\">\n" +
    "                            <a ng-click=\"$event.stopPropagation()\"  style=\"display:inline;font-weight:600;margin-left:5px\" href=\"project/{{item.from.urlTitle}}\" ui-sref=\"project.activity({id:item.from.urlTitle})\">\n" +
    "                                <img class=\"card-avatar\" ng-src=\"{{item.from.avatarUrl}}\" src=\"{{item.from.avatarUrl}}\" err-src=\"/images/avatar.png\">\n" +
    "                                {{item.from.title}}\n" +
    "                            </a>\n" +
    "                        </span>\n" +
    ...
    "                    <div style=\"display:inline\">\n" +
    "                        <span ng-if=\"item.to.username\">\n" +
    "                            <a ng-click=\"$event.stopPropagation()\"  style=\"display:inline;font-weight:600;margin-left:5px\" href=\"member/{{item.to.username}}\" ui-sref=\"member.activity({id:item.to.username})\">\n" +
    "                                <img class=\"card-avatar\" ng-src=\"{{item.to.avatarUrl}}\" src=\"{{item.to.avatarUrl}}\" err-src=\"/images/avatar.png\">\n" +
    "                                {{item.to.username}}\n" +
    "                            </a>\n" +
    "                        </span>\n" +
    "                        <span ng-if=\"item.to.title\">\n" +
    "                            <a ng-click=\"$event.stopPropagation()\"  style=\"display:inline;font-weight:600;margin-left:5px\" href=\"project/{{item.to.urlTitle}}\" ui-sref=\"project.activity({id:item.to.urlTitle})\">\n" +
    "                                <img class=\"card-avatar\" ng-src=\"{{item.to.avatarUrl}}\" src=\"{{item.to.avatarUrl}}\" err-src=\"/images/avatar.png\">\n" +
    "                                {{item.to.title}}\n" +
    "                            </a>\n" +
    "                        </span>\n" +
    ...
    "                    <p><span style=\"display:inline\" ng-bind-html=\"renderContent(item.content)\"></span></p>\n" +
    "\n" +
    "                    <p style=\"color:gray;font-size:10px\"><span style=\"color:gray\" am-time-ago=\"item.createdAt\"></span></p><!-- {{item.createdAt | date :  \"y MM-dd hh:mm.ss a\"}}</p>-->\n" +
    "\n" +
    "                </div>\n" +
    "                <div class=\"card-footer\">\n" +
    "                    <a ng-click=\"$event.stopPropagation();createReaction(item, 'plus')\"><i class=\"fa fa-angle-up\"></i> {{item.reactions.plus}} like </a> \n" +
    "                    <a ng-click=\"$event.stopPropagation();createReaction(item, 'plus')\" ><i class=\"fa fa-angle-down\"></i> {{item.reactions.minus}} dislike </a>\n" +
    "                    <a ng-click=\"$event.stopPropagation();reply(item)\"><i class=\"fa fa-comment-o\"></i> comment </a>\n" +
    "                    <a ng-click=\"$event.stopPropagation();\" class=\"pull-right\" style=\"padding:0px;\" href=\"transaction/{{item.id}}\" ui-sref=\"transaction({id:item.id})\"><i class=\"fa fa-link grey\"></i></a>\n" +
    "                </div>\n" +
    "            </div>\n" +
    "            \n" +
    "        </div>\n" +
...
angular.module("member/templates/assets.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("member/templates/assets.tpl.html",
    ...
    "                        <h5><span style=\"font-size:11px;color:gray\">0x{{member.id}}</span></h5>\n" +
    "                    </div>\n" +
    "                </div>\n" +
    "            </div>\n" +
    "        </div>\n" +
...
angular.module("member/templates/content.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("member/templates/content.tpl.html",
    ...
    "                        <a style=\"font-weight:700\"  href=\"member/{{item.user.username}}\" ui-sref=\"member.activity({path:item.user.username})\">\n" +
    "                            <img class=\"card-avatar\" ng-src=\"{{item.user.avatarUrl}}\" src=\"{{item.user.avatarUrl}}\" err-src=\"/images/avatar.png\">\n" +
    "                            {{item.user.username}}\n" +
    "                        </a>\n" +
    "                    </p>\n" +
...
angular.module("member/templates/items.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("member/templates/items.tpl.html",
    ...
    "                        <div style=\"margin-top: auto;margin-bottom: auto;\">\n" +
    "                            <div class=\"container\">\n" +
    "                                <h1 style=\"text-align:left;font-size:35px;color:rgba(255,255,255,0.9);font-weight:400;\"><a style=\"color:white\" href=\"item/{{item.id}}\" ui-sref=\"item({id:item.id})\">{{item.title}}</a></h1>\n" +
    "                            </div>\n" +
    "                        </div>\n" +
    "                    </div>\n" +
    "                </div>\n" +
...
angular.module("member/templates/ledger.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("member/templates/ledger.tpl.html",
    ...
    "				<a ng-click=\"$event.stopPropagation()\" href=\"transaction/{{item.id}}\" ui-sref=\"transaction({id:item.id})\"></a>\n" +
    "			</div>\n" +
    "			<div class=\"card-footer\">\n" +
    "				<a ng-click=\"$event.stopPropagation();createReaction(item, 'plus')\"><i class=\"fa fa-angle-up\"></i> {{item.reactions.plus}} like </a> \n" +
    "				<a ng-click=\"$event.stopPropagation();createReaction(item, 'minus')\" ><i class=\"fa fa-angle-down\"></i> {{item.reactions.minus}} dislike </a>\n" +
...
angular.module("member/templates/projects.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("member/templates/projects.tpl.html",
    ...
    "		<!--TODO RENDER PROJECT-MEMBER-->\n" +
    "		<div class=\"member-card\" ng-click=\"cardDetailToggle(project.project)\">\n" +
    "			<div class=\"member-card-image\" style=\"background-color:black\">\n" +
    "		        <a ng-click=\"$event.stopPropagation();\" href=\"project/{{project.project.title}}\" ui-sref=\"project.activity({path:project.project.urlTitle})\"><img ng-src=\"{{project.project.avatarUrl}}\" err-src=\"/images/avatar.png\"></a>\n" +
    "		    </div>\n" +
    "		    <div class=\"member-card-info\">\n" +
    "		        <h4><a ng-click=\"$event.stopPropagation();\" href=\"project/{{project.project.urlTitle}}\" ui-sref=\"project.activity({path:project.project.urlTitle})\">{{project.project.title}}</a></h4>\n" +
    "		        <p style=\"color:gray\">{{project.status}}</p>\n" +
...
angular.module("member/templates/tasks.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("member/templates/tasks.tpl.html",
    ...
    "                        <div style=\"margin-top: auto;margin-bottom: auto;\">\n" +
    "                            <div class=\"container\">\n" +
    "                                <h1 style=\"text-align:left;font-size:35px;color:rgba(255,255,255,0.9);font-weight:400;\"><a ng-click=\"$event.stopPropagation()\" href=\"task/{{item.id}}\" ui-sref=\"task({id:item.id})\" style=\"color:white\">{{item.title}}</h1>\n" +
    "                            </div>\n" +
    "                        </div>\n" +
    "                    </div>\n" +
    "                </div>\n" +
    ...
    "					<a ng-click=\"$event.stopPropagation();createReaction(item, 'plus')\" ><i class=\"fa fa-angle-down\"></i> {{item.reactions.minus}} dislike </a>\n" +
    "					<a ng-click=\"$event.stopPropagation();reply(item)\"><i class=\"fa fa-comment-o\"></i> comment </a>\n" +
    "					<a ng-click=\"$event.stopPropagation();\" style=\"padding:0px\" class=\"pull-right\" href=\"item/{{item.id}}\" ui-sref=\"task({id:item.id})\"><i class=\"fa fa-link grey\"></i></a>\n" +
    "				</div>\n" +
    "				<div ng-click=\"$event.stopPropagation();\" ng-show=\"item.showReply\" class=\"card-footer\">\n" +
    "		            <form role=\"form\" ng-submit=\"createContent(item)\">\n" +
    "		                <text-angular ng-model=\"newContent.content\" ta-toolbar=\"[['p','h1','h2','bold','italics','quote','pre','insertLink', 'html']]\"></text-angular>\n" +
...
angular.module("member/templates/time.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("member/templates/time.tpl.html",
    ...
    "                    <a ng-click=\"$event.stopPropagation();createReaction(item, 'minus')\" ><i class=\"fa fa-angle-down\"></i> {{item.reactions.minus}} dislike </a>\n" +
    "                    <a ng-click=\"$event.stopPropagation();reply(item)\"><i class=\"fa fa-comment-o\"></i> comment </a>\n" +
    "                    <a ng-click=\"$event.stopPropagation()\" class=\"pull-right\" style=\"padding:0px;\" href=\"time/{{item.id}}\" ui-sref=\"time({id:item.id})\"><i class=\"fa fa-link grey\"></i></a>\n" +
    "                </div>\n" +
    "                <div ng-click=\"$event.stopPropagation()\" ng-show=\"item.showReply\" class=\"card-footer\">\n" +
    "    		        <form style=\"cursor:text;\" role=\"form\" ng-submit=\"createContent(item)\">\n" +
    "    		            <text-angular ng-model=\"newContent.content\" ta-toolbar=\"[['p','h1','h2','bold','italics','quote','pre','insertLink', 'html']]\"></text-angular>\n" +
...
angular.module("members/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("members/index.tpl.html",
    ...
    "                <div class=\"member-card-info\" style=\"padding:16px;height:auto\">\n" +
    "                    \n" +
    "                    <h4 ng-click=\"$event.stopPropagation()\"><a href=\"member/{{item.username}}\" ui-sref=\"member.activity({path:item.username})\">{{item.username}}</a></h4>\n" +
    "                    \n" +
    "                    <p style=\"font-size:11px;\" ng-click=\"$event.stopPropagation()\"><a href=\"/member/{{item.username}}/projects\" ui-sref=\"member.projects({path:item.username})\">{{item.projectCount || 0}} Projects</a> | <a href=\"/member/{{item.username}}/followers\" ui-sref=\"member.followers({path:item.username})\">{{item.followerCount || 0}} Followers</a> | <a href=\"/member/{{item.username}}/following\" ui-sref=\"member.following({path:item.username})\">{{item.followingCount || 0}} Following</a>\n" +
    "                    \n" +
...
angular.module("nav/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("nav/index.tpl.html",
    ...
    "                    <tags-input min-length=\"1\" placeholder=\"Accociated Protocols\" ng-model=\"newProtocol.associatedProtocols\">\n" +
    "                        <auto-complete source=\"loadItems($query)\"></auto-complete>\n" +
    "                    </tags-input>\n" +
    "                    <h5>Protocol Title</h5>\n" +
    "                    <input type=\"text\" placeholder=\"Title\" ng-model=\"newProtocol.title\" class=\"form-control\">\n" +
    "                    <h5>Protocol Code</h5>\n" +
    ...
    "                    <a>Create Action <i style=\"float:right\" class=\"fas fa-exclamation\"></i></a>\n" +
    "                </h4>\n" +
    "\n" +
    "                <!--ACTIONs below..?-->\n" +
    ...
    "                            <h5 style=\"text-align:left;color:rgba(255,255,255,0.9);font-weight:400;\">{{item.username}}</h5>\n" +
    "                        </div>\n" +
    "                    </div>\n" +
    "                </div>\n" +
    "            </div>\n" +
    ...
    "\n" +
    "            <div style=\"min-height:500px;max-height:100vh;overflow:hidden\">\n" +
    "                <h4 ng-show=\"!currentUser\" class=\"nav-links\" style=\"padding:8px;\"><a href=\"/about\" ui-sref=\"about\">About</a></h4>\n" +
    ...
    "                        <div style=\"padding:15px\" style=\"width:100%\">\n" +
    "                            <h1 style=\"font-size:14px;color:rgba(255,255,255,0.9);font-weight:400;\">\n" +
    "                                <span ng-if=\"item.title\" ui-sref=\"project.activity\">\n" +
    ...
    "                    <h4 class=\"nav-links\"><a href=\"project/{{item.urlTitle}}/about\" ui-sref=\"project.about\">About</a></h4>\n" +
    "                    <h4 class=\"nav-links\"><a href=\"project/{{item.urlTitle}}/assets\" ui-sref=\"project.activity\">Assets</a></h4>\n" +
    "                    <h4 class=\"nav-links\"><a href=\"project/{{item.urlTitle}}/content\" ui-sref=\"project.content\">Content</a></h4>\n" +
    "                    <h4 class=\"nav-links\"><a href=\"project/{{item.urlTitle}}/items\" ui-sref=\"project.items\">Items</a></h4>\n" +
    "                    <h4 class=\"nav-links\"><a href=\"project/{{item.urlTitle}}/ledger\" ui-sref=\"project.ledger\">Ledger</a></h4>\n" +
    "                    <h4 class=\"nav-links\"><a href=\"project/{{item.urlTitle}}/members\" ui-sref=\"project.members\">{{item.memberCount}} Members</a></h4>\n" +
    "                    <h4 class=\"nav-links\"><a href=\"project/{{item.urlTitle}}/charter\" ui-sref=\"project.charter\">Motions</a></h4>\n" +
    "                    <h4 class=\"nav-links\"><a href=\"project/{{item.urlTitle}}/positions\" ui-sref=\"project.positions\">Positions</a></h4>\n" +
    "                    <h4 class=\"nav-links\"><a href=\"project/{{item.urlTitle}}/projects\" ui-sref=\"project.projects\">Projects</a></h4>\n" +
    "                    <h4 class=\"nav-links\"><a href=\"project/{{item.urlTitle}}/tasks\" ui-sref=\"project.tasks\">Tasks</a></h4>\n" +
    "                    <h4 class=\"nav-links\"><a href=\"project/{{item.urlTitle}}/time\" ui-sref=\"project.time\">Time</a></h4>\n" +
    "                    <!--<h4 class=\"nav-links\"><a href=\"project/{{project.urlTitle}}/charter\">Validations</a></h4>-->\n" +
    "                </div>\n" +
    "                <div ng-if=\"item.username\">\n" +
    "                    <h4 class=\"nav-links\"><a href=\"member/{{item.username}}/about\" ui-sref=\"member.about\">About</a></h4>\n" +
    "                    <h4 class=\"nav-links\"><a href=\"member/{{item.username}}/actions\" ui-sref=\"member.actions\">Actions</a></h4>\n" +
    "                    <h4 class=\"nav-links\"><a href=\"member/{{item.username}}/assets\" ui-sref=\"member.assets\">Assets</a></h4>\n" +
    "                    <h4 class=\"nav-links\"><a href=\"member/{{item.username}}/content\" ui-sref=\"member.content\">Content</a></h4>\n" +
    "                    <h4 class=\"nav-links\"><a href=\"member/{{item.username}}/followers\" ui-sref=\"member.followers\">{{item.followerCount}} Followers</a></h4>\n" +
    "                    <h4 class=\"nav-links\"><a href=\"member/{{item.username}}/following\" ui-sref=\"member.following\">{{item.followingCount}} Following</a></h4>\n" +
    "                    <h4 class=\"nav-links\"><a href=\"member/{{item.username}}/items\" ui-sref=\"member.items\">Items</a></h4>\n" +
    "                    <h4 class=\"nav-links\"><a href=\"member/{{item.username}}/ledger\" ui-sref=\"member.ledger\">Ledger</a></h4>\n" +
    "                    <h4 class=\"nav-links\"><a href=\"member/{{item.username}}/positions\" ui-sref=\"member.positions\">Positions</a></h4>\n" +
    "                    <h4 class=\"nav-links\"><a href=\"member/{{item.username}}/projects\" ui-sref=\"member.projects\">{{item.projectCount}} Projects</a></h4>\n" +
    "                    <h4 class=\"nav-links\"><a href=\"member/{{item.username}}/tasks\" ui-sref=\"member.tasks\">Tasks</a></h4>\n" +
    "                    <h4 class=\"nav-links\"><a href=\"member/{{item.username}}/time\" ui-sref=\"member.time\">Time</a></h4>\n" +
    "                </div>\n" +
    "\n" +
    "            </div>\n" +
    "        </div>\n" +
    ...
    "\n" +
    "            <a style=\"padding-left:0px\" class=\"navbar-brand\" href=\"/\" ui-sref=\"home\"><span style=\"font-weight:bold;color:white\">CRE8.XYZ</span></a>\n" +
    "        </div>\n" +
...
angular.module("notifications/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("notifications/index.tpl.html",
    ...
    "	            	<a ng-click=\"$event.stopPropagation()\" style=\"display:inline;font-weight:600;margin-left:5px\" href=\"member/{{notification.info.username}}\" ui-sref=\"member.activity({path:notification.info.username})\">\n" +
    "	                	<img class=\"card-avatar\" ng-src=\"{{notification.info.avatarUrl}}\" err-src=\"/images/avatar.png\">\n" +
    ...
    "	            	<p>\n" +
    "		            	<a ng-click=\"$event.stopPropagation()\" style=\"display:inline;font-weight:600;margin-left:5px\" href=\"member/{{notification.info.user.username}}\" ui-sref=\"member.activity({path:notification.info.user.username})\">\n" +
    "		                	<img class=\"card-avatar\" ng-src=\"{{notification.info.user.avatarUrl}}\" err-src=\"/images/avatar.png\">\n" +
    ...
    "                	<p><a ng-click=\"$event.stopPropagation();\" href=\"content/{{notification.info.content.id}}\" ui-sref=\"content({id:notification.info.content.id})\">{{notification.info.content.title}}</a></p>\n" +
    "                	<p><a ng-click=\"$event.stopPropagation();\" href=\"content/{{notification.info.content.id}}\" ui-sref=\"content({id:notification.info.content.id})\">{{notification.info.content.id}}</a></p>\n" +
    ...
    "\n" +
    "	            	<!--CHECK KEYS OF OBJECT INFO..-->\n" +
    "    	            <div style=\"display:inline\">\n" +
    "\n" +
    "		            	<a ng-click=\"$event.stopPropagation()\" style=\"display:inline;font-weight:600;margin-left:5px\" href=\"member/{{notification.info.member.username}}\" ui-sref=\"member.activity({path:notification.info.member.username})\">\n" +
    "		                	<img class=\"card-avatar\" ng-src=\"{{notification.info.member.avatarUrl}}\" err-src=\"/images/avatar.png\">\n" +
    "		                	{{notification.info.member.username}}\n" +
    "		                </a>\n" +
    "		                <div style=\"display:inline;padding-left:5px;padding-right:5px;\">\n" +
    "			                <i class=\"fa fa-arrow-right\"></i>\n" +
    "			            </div>\n" +
    "		                <a ng-click=\"$event.stopPropagation()\" style=\"display:inline;font-weight:600;margin-left:5px\" href=\"member/{{notification.info.project.title}}\" ui-sref=\"member.activity({path:notification.info.member.username})\">\n" +
    "		                	<img class=\"card-avatar\" ng-src=\"{{notification.info.project.avatarUrl}}\" err-src=\"/images/avatar.png\">\n" +
    "		                	{{notification.info.project.title}}\n" +
    "		                </a>\n" +
    "		                <!--\n" +
    "		                <div style=\"display:inline;padding-left:5px;padding-right:5px;\">\n" +
    "			                <i class=\"fa fa-arrow-right\"></i>\n" +
    "			            </div>\n" +
    "			            <a ng-click=\"$event.stopPropagation()\" style=\"display:inline;font-weight:600;margin-left:5px\" href=\"/member/{{notification.info.project.title}}\">\n" +
    "		                	<img class=\"card-avatar\" ng-src=\"{{notification.info.project.avatarUrl}}\" err-src=\"/images/avatar.png\">\n" +
    "		                	{{notification.info.project.title}}\n" +
    "		                </a>\n" +
    "		            	-->\n" +
...
angular.module("order/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("order/index.tpl.html",
    ...
    "        <ul style=\"padding:0px;\" class=\"member-tabs\">\n" +
    "            <li><a ng-click=\"selectTab('INFORMATION')\" href=\"#\">Information</a></li>\n" +
    "            <li><a ng-click=\"selectTab('ORDERS')\" href=\"#\">Orders</a></li>\n" +
    "            <li><a ng-click=\"selectTab('TRANSACTIONS')\" href=\"#\">Transactions (Trades)</a></li>\n" +
    "        </ul>\n" +
    "    </div>\n" +
    "\n" +
    "    <div class=\"row\">\n" +
    ...
    "\n" +
    "        <!--TRANSACTIONS-->\n" +
    "        <div ng-if=\"selectedTab =='TRANSACTIONS'\">\n" +
    "            <div class=\"card\">\n" +
    "                <div style=\"background:url('https://source.unsplash.com/1600x900/?explore,discover')\" class=\"imageContainerSmall\">\n" +
    "                    <div style=\"background:rgba(0,0,0,0.75)\" class=\"imageContainerSmallDiv\">  \n" +
    "                        <div style=\"margin-top: auto;margin-bottom: auto;\">\n" +
    ...
    "                </div>\n" +
    "                <div style=\"padding:16px\">  \n" +
    "                    <h5>Two Transactions on a Trade</h5>\n" +
...
angular.module("project/templates/about.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("project/templates/about.tpl.html",
    ...
    "            <p><b>Manifolds</b></p> \n" +
    "            <p>\n" +
    "                <a href=\"market/{{project.urlTitle.toUpperCase()}}\" ui-sref=\"market({id:project.urlTitle.toUpperCase()})\">{{project.urlTitle.toUpperCase()}}+</a>, \n" +
    "                <a href=\"market/{{project.urlTitle.toUpperCase()}}+TASK+\">{{project.urlTitle.toUpperCase()}}+TASK+</a>, \n" +
    "                <a href=\"{{market/project.urlTitle.toUpperCase()}}+TIME+\">{{project.urlTitle.toUpperCase()}}+TIME+</a>\n" +
    "            </p>\n" +
    "            <div class=\"spacing-5\"></div>\n" +
    "\n" +
    "        </div>\n" +
...
angular.module("project/templates/activity.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("project/templates/activity.tpl.html",
    ...
    "                    <div>\n" +
    "                        <img class=\"card-avatar\" ng-src=\"{{item.user.avatarUrl}}\" src=\"{{item.user.avatarUrl}}\" err-src=\"/images/avatar.png\">\n" +
    "                        <a ng-click=\"$event.stopPropagation()\" style=\"display:inline;font-weight:600;margin-left:5px\" href=\"member/{{item.user.username}}\" ui-sref=\"member.activity({path:item.user.username})\">{{item.user.username}}</a>\n" +
    "                        <p style=\"display:inline;font-size:10px;color:gray;margin-left:5px\" am-time-ago=\"item.createdAt\"></p>\n" +
    "                    </div>\n" +
    "                    <div style=\"margin-left:42px\"><span style=\"display:inline\" ng-bind-html=\"renderContent(item.content)\"></span></div>\n" +
    "                </div>\n" +
    ...
    "                        <div style=\"margin-top: auto;margin-bottom: auto;\">\n" +
    "                            <div class=\"container\">\n" +
    "                                <h1 ng-click=\"$event.stopPropagation()\" style=\"text-align:left;font-size:35px;color:rgba(255,255,255,0.9);font-weight:400;\">\n" +
    "                                    <a style=\"color:white\" href=\"task/{{item.id}}\" ui-sref=\"task({id:item.id})\">{{item.title}}</a>\n" +
    "                                </h1>\n" +
    "                                <h5 ng-click=\"$event.stopPropagation()\"><a style=\"color:white\" href=\"task/{{item.id}}\" ui-sref=\"task({id:item.id})\">{{item.id}}</a></h5>\n" +
    "                            </div>\n" +
    "                        </div>\n" +
    "                    </div>\n" +
    "                </div>\n" +
    ...
    "                    <a ng-click=\"$event.stopPropagation();createReaction(item, 'minus')\" ><i class=\"fa fa-angle-down\"></i> {{item.reactions.minus}} dislike </a>\n" +
    "                    <a ng-click=\"$event.stopPropagation();reply(item)\"><i class=\"fa fa-comment-o\"></i> comment </a>\n" +
    "                    <a ng-click=\"$event.stopPropagation()\" style=\"padding:0px\" class=\"pull-right\" href=\"transaction/{{item.id}}\" ui-sref=\"transaction({id:item.id})\"><i class=\"fa fa-link grey\"></i></a>\n" +
    "                </div>\n" +
    "            </div>\n" +
    "        </div>      \n" +
    "    </div>\n" +
...
angular.module("project/templates/channels.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("project/templates/channels.tpl.html",
    ...
    "                    <a style=\"padding:0px\" class=\"pull-right\" href=\"content/{{item.id}}\" ui-sref=\"content({id:item.id})\"><i class=\"fa fa-link grey\"></i></a>\n" +
    "                </div>\n" +
    "                <div ng-show=\"item.showReply\" class=\"card-footer\">\n" +
    "                    <form role=\"form\" ng-submit=\"createContent(item)\">\n" +
    "                        <text-angular ng-model=\"newContent.content\" ta-toolbar=\"[['p','h1','h2','bold','italics','quote','pre','insertLink', 'html']]\"></text-angular>\n" +
...
angular.module("project/templates/content.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("project/templates/content.tpl.html",
    ...
    "                    \n" +
    "                    <div style=\"\">\n" +
    "                        <a ng-click=\"$event.stopPropagation()\" style=\"font-weight:700\" href=\"member/{{item.user.username}}\" ui-sref=\"member.activity({path:item.user.username})\">\n" +
...
angular.module("project/templates/ledger.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("project/templates/ledger.tpl.html",
    ...
    "\n" +
    "				<div style=\"float:right;text-align:right\">\n" +
    "                	<a ng-click=\"$event.stopPropagation();cardDetailToggle(task)\"><span style=\"color:gray\"><i class=\"fa fa-ellipsis-v\"></i></span></a>\n" +
    "                </div>\n" +
    "		\n" +
    "                <div style=\"display:inline\">\n" +
    "                    <span ng-if=\"transaction.from.username\">\n" +
    ...
    "				<a ng-click=\"$event.stopPropagation();\" class=\"pull-right\" style=\"padding:0px;\" href=\"transaction/{{transaction.id}}\" ui-sref=\"transaction({id:transaction.id})\"><i class=\"fa fa-link grey\"></i></a>\n" +
    "			</div>\n" +
...
angular.module("project/templates/positions.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("project/templates/positions.tpl.html",
    ...
    "	                <a href=\"#\" ng-click=\"createReaction(item, 'minus')\" ><i class=\"fa fa-angle-down\"></i> {{item.reactions.minus}} dislike </a>\n" +
    "	                <a href=\"#\" ng-click=\"reply(item)\"><i class=\"fa fa-comment-o\"></i> comment </a>\n" +
    "	                <a class=\"pull-right\" style=\"padding:0px;\" href=\"order/{{item.id}}\" ui-sref=\"order({id:item.id})\"><i class=\"fa fa-link grey\"></i></a>\n" +
    "	            </div>\n" +
    "	        </div>\n" +
    "		</div>\n" +
    "	</div>\n" +
...
angular.module("project/templates/projects.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("project/templates/projects.tpl.html",
    ...
    "			<div style=\"padding:16px;\">\n" +
    "				<div class=\"row\">\n" +
    "                    <div class=\"col-sm-1 col-xs-2\"><a ng-click=\"$event.stopPropagation();\" href=\"project/{{project.urlTitle}}\" ui-sref=\"project.activity({path:project.urlTitle})\"><img style=\"width:100%;height:100%\" src=\"{{project.avatarUrl}}\"></a></div>\n" +
    "                    <div class=\"col-sm-11 col-xs-10\">\n" +
    "                    	<!--TODO: ON CLICK RENDER ASSOCIATIONS.. DETAIL.. ETC VALIDATIONS.. SPECIFIC 'ITEM' FILTER THU CARDDETAIL-->\n" +
    "                        <h3 style=\"margin-top:0px\"><a ng-click=\"$event.stopPropagation();\" href=\"project/{{project.urlTitle}}\" ui-sref=\"project.activity({path:project.urlTitle})\">{{project.title}}</a></h3>\n" +
...
angular.module("project/templates/tasks.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("project/templates/tasks.tpl.html",
    ...
    "		<div ng-repeat=\"item in tasks\">\n" +
    "			<div class=\"card\" ng-click=\"cardDetailToggle(item)\">\n" +
    "				<div style=\"background:url('https://source.unsplash.com/1600x900/?{{item.tags}}');min-height:200px;\" class=\"imageContainerSmall\">\n" +
    ...
    "	                    	<a style=\"float:right;text-align:right;padding:16px\" ng-click=\"$event.stopPropagation();cardDetailToggle(item)\"><span style=\"color:white\"><i class=\"fa fa-ellipsis-v\"></i></span></a>\n" +
    "	                    </div>\n" +
    "	                	-->\n" +
    "                        <div style=\"margin-top: auto;margin-bottom: auto;\">\n" +
    "                            <div style=\"padding:15px\">\n" +
    "                                <h1 ng-click=\"$event.stopPropagation()\" style=\"text-align:left;font-size:35px;color:rgba(255,255,255,0.9);font-weight:400;\"><a style=\"color:white\" href=\"task/{{item.id}}\" ui-sref=\"task({id:item.id})\">{{item.title}}</h1>\n" +
    "                                <h5 ng-click=\"$event.stopPropagation()\"><a style=\"color:white\" href=\"task/{{item.id}}\" ui-sref=\"task({id:item.id})\">{{item.id}}</a></h5>\n" +
    "                            </div>\n" +
    "                        </div>\n" +
    "                    </div>\n" +
    ...
    "                    </div>\n" +
    "					<p>\n" +
    "						<!--<i class=\"fas fa-project-diagram\"></i>--> <a ng-click=\"$event.stopPropagation()\" ng-repeat=\"tag in item.tags\" href=\"market/{{tag.trim()}}\"><b>{{tag.trim()}}</b> </a>\n" +
    "					</p>\n" +
    "                    <p><span style=\"display:inline\" ng-bind-html=\"renderContent(item.content)\"></span></p>\n" +
    "					<span style=\"color:gray\" am-time-ago=\"item.createdAt\"></span>\n" +
    "				</div>\n" +
...
angular.module("projects/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("projects/index.tpl.html",
    ...
    "                    <div class=\"row\">\n" +
    "                        <div class=\"col-sm-1 col-xs-2\">\n" +
    "                            <a ng-click=\"$event.stopPropagation()\" href=\"project/{{project.urlTitle}}\" ui-sref=\"project.activity({path:project.urlTitle})\"><img style=\"width:100%;height:100%\" ng-src=\"{{project.avatarUrl}}\"></a>\n" +
    "                        </div>\n" +
    "                        <div class=\"col-sm-11 col-xs-10\">\n" +
    "                            <p style=\"float:right;text-align:right\">\n" +
    ...
    "                            </p>\n" +
    "                            <h3 style=\"float:left;margin-top:0px\"><a ng-click=\"$event.stopPropagation()\" href=\"project/{{project.urlTitle}}\" ui-sref=\"project.activity({path:project.urlTitle})\">{{project.title}}</a></h3>\n" +
    "                            <div style=\"clear:both\"></div>\n" +
    "                            <div>\n" +
...
angular.module("task/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("task/index.tpl.html",
    ...
    "\n" +
    "        <!--TODO: MOTION TO EDIT-->\n" +
    "        <div ng-if=\"currentUser.id == task.user\">\n" +
    "            <ul style=\"padding:0px;margin-top:0px;margin-bottom:0px;\" class=\"member-tabs\">\n" +
    ...
    "                    </div>\n" +
    "                    <p><a ng-repeat=\"tag in task.tags track by $index\" href=\"market/{{tag.trim()}}\" ui-sref=\"market({id:tag.trim()})\"> {{tag.trim()}}<span ng-show=\"!$last\">,</span></a></p>\n" +
...
angular.module("tasks/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("tasks/index.tpl.html",
    ...
    "	                        <div style=\"margin-top: auto;margin-bottom: auto;\">\n" +
    "	                            <div class=\"container\">\n" +
    "	                                <h1 style=\"text-align:left;font-size:35px;color:rgba(255,255,255,0.9);font-weight:400;\"><a ng-click=\"$event.stopPropagation();\" style=\"color:white\" href=\"task/{{item.id}}\" ui-sref=\"task({id:item.id})\">{{item.title}}</a></h1>\n" +
    "	                            </div>\n" +
    "	                        </div>\n" +
    "	                    </div>\n" +
    "	                </div>\n" +
...
angular.module("time/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("time/index.tpl.html",
    ...
    "                \n" +
    "                <!--TODO-->\n" +
    "                <p><a ng-repeat=\"tag in time.task.tags track by $index\" href=\"market/{{tag.trim()}}\" ui-sref=\"market({id:tag.trim()})\">{{tag.trim()}}<span ng-show=\"!$last\">,</span> </a></p>\n" +
    "				<p><a ng-repeat=\"tag in time.tags track by $index\" href=\"market/{{tag.trim()}}\" ui-sref=\"market({id:tag.trim()})\">{{tag.trim()}}<span ng-show=\"!$last\">,</span> </a></p>\n" +
    "\n" +
...
angular.module("transaction/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("transaction/index.tpl.html",
    ...
    "            <a ng-click=\"$event.stopPropagation();createReaction(item, 'plus')\"><i class=\"fa fa-angle-up\"></i> {{item.reactions.plus}} like </a> \n" +
    "            <a ng-click=\"$event.stopPropagation();createReaction(item, 'minus')\" ><i class=\"fa fa-angle-down\"></i> {{item.reactions.minus}} dislike </a>\n" +
    "            <a style=\"padding:5px;color:grey\" href=\"#\" ng-click=\"reply(item)\" ui-sref=\"content({id:item.user.username})\"><i class=\"fa fa-comment-o\"></i> comment </a>\n" +
    "            <a style=\"color:grey\" class=\"pull-right\" href=\"content/{{item.id}}\" ui-sref=\"content({id:item.user.username})\"><i class=\"fa fa-link grey\"></i></a>\n" +
    "        </div>\n" +
    "        <!--TODO: NESTED -->\n" +
    "        <div ng-show=\"transaction.showReply\" class=\"card-footer\">\n" +
    "            <form role=\"form\" ng-submit=\"createContent(transaction)\">\n" +
...
angular.module("transparency/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("transparency/index.tpl.html",
    ...
    "			</div>\n" +
    "			<div style=\"padding:16px;\">\n" +
    "				<h5><a href=\"project/conexus\" ui-sref=\"project.activity({path:'conexus'})\">Conexus Project</a></h5>\n" +
