...
.config(['$stateProvider', function config( $stateProvider ) {
    $stateProvider.state( 'apps', {
        url: '/apps',
        views: {"main": {controller: 'AppsController',templateUrl: 'apps/index.tpl.html'}},
        resolve: {
            apps: ['AppModel', function(AppModel){return AppModel.get({limit:100, skip:0, sort:'createdAt DESC'});}],
        }
    });
}])
