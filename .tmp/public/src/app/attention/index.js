...
.config(['$stateProvider', function config( $stateProvider ) {
    $stateProvider.state( 'attention', {
        url: '/attention/:id',
        views: {"main": {controller: 'AttentionController', templateUrl: 'attention/index.tpl.html'}},
        resolve: {attention: ['$stateParams', 'AttentionModel', function($stateParams, AttentionModel){return AttentionModel.get({id:$stateParams.id});}],}
    });
}])
