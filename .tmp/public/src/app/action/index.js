...
.config(['$stateProvider', function config( $stateProvider ) {
    $stateProvider.state( 'action', {
        url: '/action/:id',
        views: {"main": {controller: 'ActionController', templateUrl: 'action/index.tpl.html'}},
        resolve: {action: ['$stateParams', 'ActionModel', function($stateParams, ActionModel) {return ActionModel.get({id:$stateParams.id});}]}
    });
}])
