...
.config(['$stateProvider', function config( $stateProvider ) {
    $stateProvider.state( 'markets', {
        url: '/market',
        views: {"main": {controller: 'MarketsCtrl', templateUrl: 'markets/index.tpl.html'}},
        //TODO: DEPRECIATE RESOLVE
        resolve:{tokens: ['TokenModel', function(TokenModel) {return TokenModel.get({limit:100, skip:0, sort:'createdAt DESC'});}],}
    });
}])
