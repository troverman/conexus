...
.config(['$stateProvider', function config( $stateProvider ) {
	$stateProvider.state( 'marketPair', {
		...
		views: {"main": {controller: 'MarketPairCtrl', templateUrl: 'marketPair/index.tpl.html'}},  
        //TODO: DEPRECIATE RESOLVE
        resolve:{
            orders: ['$stateParams', 'OrderModel', function($stateParams, OrderModel) {return OrderModel.get({setAlpha:$stateParams.setAlpha, setBeta:$stateParams.setBeta, limit:400, skip:0, sort:'createdAt DESC'});}],
            mirrorOrders: ['$stateParams', 'OrderModel', function($stateParams, OrderModel) {return OrderModel.get({setAlpha:$stateParams.setBeta, setBeta:$stateParams.setAlpha, limit:400, skip:0, sort:'createdAt DESC'});}],
            contentList: ['$stateParams', 'ContentModel', function($stateParams, ContentModel) {return ContentModel.get('marketPair', $stateParams.setAlpha, $stateParams.setBeta, 400, 0, 'createdAt DESC');}],
        }
	});
}])
